...
Public Class crpBOXEstero2020
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDocumentazione.crpBOXEstero2020.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpBOXEstero2020
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpBOXEstero2020 = New crpBOXEstero2020()
        rpt.Site = Me.Site
        Return rpt
    End Function
