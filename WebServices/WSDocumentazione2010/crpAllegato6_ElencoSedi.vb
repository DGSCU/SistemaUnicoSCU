...
Public Class crpAllegato6_ElencoSedi
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crpAllegato6_ElencoSedi.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "WSDocumentazione.crpAllegato6_ElencoSedi.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IDEnte() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrpAllegato6_ElencoSedi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpAllegato6_ElencoSedi = New crpAllegato6_ElencoSedi()
        rpt.Site = Me.Site
        Return rpt
    End Function
