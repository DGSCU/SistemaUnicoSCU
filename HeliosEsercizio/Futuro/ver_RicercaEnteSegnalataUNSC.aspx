<%@ Page Title="Ricerca Ente per Verifica Segnala DGSCN" Language="vb" AutoEventWireup="false" CodeBehind="ver_RicercaEnteSegnalataUNSC.aspx.vb"
    Inherits="Futuro.ver_RicercaEnteSegnalataUNSC" %>
...
<body>
    ...
    <div class="wrapper" style="width: 100%">
        <div class="headers">
            <h2>
                <asp:Label ID="lblTitolo" runat="server" Text="Ricerca Enti"></asp:Label></h2>
        </div>
    </div>
    <div class="rowGroup" style="height: auto">
        <div class="RigaVuota">
     ...
     <div class="rowGroup" style="height: auto">
        ...
        <div class="row" id="div1" runat="server">
            <div class="collable" style="width: 15%">
                <asp:Label ID="Label21" CssClass="label" runat="server" Text="Descr. Ente" AssociatedControlID="TxtDescrEnte" />
            </div>
        ...
        <div class="row" id="div3" runat="server">
            <div class="collable" style="width: 15%">
                <asp:Label ID="Label20" CssClass="label" runat="server" Text="Cod. Ente" AssociatedControlID="TxtCodEnte" />
            </div>
            <div class="colOggetti" style="width: 35%">
                <asp:TextBox ID="TxtCodEnte" runat="server" CssClass="textbox"></asp:TextBox>
            </div>
            <div class="collable" style="width: 15%">
                <asp:Label ID="lblCompentenza" CssClass="label" runat="server" Text="Competenza"
                    AssociatedControlID="ddlCompetenza" />
            </div>
            <div class="colOggetti" style="width: 35%">
        ...
        <asp:DataGrid ID="dgEnte" runat="server" Width="100%" ToolTip="Elenco Progetti"
            CellPadding="2" Font-Size="Small" CssClass="table" AllowSorting="True" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateColumn> 
                    <ItemTemplate>
                        <asp:ImageButton ID="imgente" CommandName="seleziona" ToolTip="Seleziona Ente" AlternateText="Seleziona Ente" runat="server" ImageURL="images/ente_small.png" CausesValidation="false"></asp:ImageButton>                         
                    </ItemTemplate>
                </asp:TemplateColumn>
                ...
                <asp:BoundColumn DataField="Descrizione" HeaderText="Competenza Ente">
