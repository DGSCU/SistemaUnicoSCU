<%@ Page Title="Istanza presentazione Programmi di intervento" Language="vb" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.Master" CodeBehind="WfrmProgrammiIstanzaPresenta.aspx.vb" Inherits="Futuro.WfrmProgrammiIstanzaPresenta" %>
...
<script type="text/javascript">
	...
	$(document).ready(function (){
        ...
        <% End If%>
	<%  If hfLettoImpegno.Value <> True AndAlso Not chkImpegno.Checked Then%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset class="ContornoPagina" id="FidsetPagina" runat="server">
        <legend>Istanza di presentazione Programmi di intervento</legend>
			...
			<strong>Chiede di presentare i programmi e relativi progetti associati a: <asp:Label runat="server" ID="txtBando"></asp:Label></strong>
            <hr />
            ...
            <asp:LinkButton runat="server" ID="lnkImpegno" Text="Scarica la dichiarazione sostitutiva di atto di notorietà" OnClick="lnkDownload_Click" ></asp:LinkButton>
            <asp:label runat="server" ID="hashImpegno"/>
            <br /><br />
            <asp:CheckBox runat="server" ID="chkImpegno" OnCheckedChanged="chkImpegno_CheckedChanged" />
			<strong>Accettata la dichiarazione sostitutiva di atto di notorietà</strong>
...
<%--			<hr />
			...
			<h4>Istanza di presentazione Programmi di intervento</h4>
			<p>È necessario scaricare l'istanza di presentazione Programmi di intervento, apporre la firma digitale e ricaricare il documento firmato</p>
			<br />
			...
			<br />
			<br />
            <asp:Button runat="server" Text="Scarica Istanza di presentazione Programmi di intervento" Id="Riepilogo" CssClass="Pulsante"/>
			<br /><br />
			<div class="row" runat="server" id="NorowRiepilogo">
				<div class="collable" style="width: 25%">
					<asp:Label ID="lblRiepilogo" CssClass="label" AssociatedControlID="cmdCaricaFileRiepilogo" runat="server" Text="Istanza di presentazione Programmi di intervento Firmata"></asp:Label>
				</div>
                <div class="colOggetti" style="width: 35%">
			...
			<div class="row" runat="server" id="rowRiepilogo">
				<table class="table" cellspacing="0" cellpadding="2" rules="all" border="1" id="MainContent_dtgConsultaDocumenti" style="font-size: Small; width: 100%; border-collapse: collapse;">
					<caption>
						Istanza di presentazione Programmi di intervento
					</caption>
					<tbody>
						<tr>
						...
						<tr class="tr" align="center" runat="server" id="rowAllegato">
							<td>
								<asp:ImageButton runat="server" ID="btnDownloadCV" ImageUrl="images/giu_small.png" AlternateText="Scarica Domanda di Adeguamento" ToolTip="Scarica Domanda di Adeguamento" OnClick="btnDownloadRiepilogo_Click"/>
							</td>
							<td>
            ...
            <asp:Button Text="Chiudi" runat="server" Id="btnChiudi" CssClass="Pulsante" OnClick="btnChiudi_Click"/>
	...
	<asp:Panel ID="pnlUploadRiepilogo" runat="server" Style="background-color: White; padding: 20px; width: 100%; overflow-y: auto; max-height: 90vh">
        ...
        <p class="msgInfo">Caricamento Istanza di presentazione Programmi di intervento</p>
        <fieldset>
