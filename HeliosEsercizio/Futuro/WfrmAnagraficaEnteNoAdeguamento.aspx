<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmAnagraficaEnteNoAdeguamento.aspx.vb" Inherits="Futuro.wfrmAnagraficaEnteNoAdeguamento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server">
     ...
     <fieldset class="ContornoPagina">
        <legend>Modifica Rapida Anagrafica Enti</legend>
        <asp:Label ID="lblMessaggio" runat="server" CssClass="msgErrore"></asp:Label>
        <div class="wrapper" style="width: 100%">
            <div class="headers">
                <h2>
                    <asp:Label ID="lblTitolo" runat="server" Text="Modifica Anagrafica Enti"></asp:Label></h2>
            </div>
            <div class="RigaVuota">
                &nbsp;</div>
        </div>
