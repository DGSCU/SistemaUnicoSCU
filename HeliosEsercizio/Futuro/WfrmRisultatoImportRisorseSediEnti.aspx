<%@ Page Title="Importazione" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmRisultatoImportRisorseSediEnti.aspx.vb" Inherits="Futuro.WfrmRisultatoImportRisorseSediEnti" %>
...
<legend>Risultati importazione</legend>
    ...
    <div class="rowGroup" id="divWarning" runat="server" visible="false">
       <div class="row">
            Tra parentesi quadre [segnalazione] vengono evidenziate possibili anomalie da verificare che non precludono all&rsquo;inserimento della sede.
       </div>
        <div class="RigaVuota">
            &nbsp;
        </div>
