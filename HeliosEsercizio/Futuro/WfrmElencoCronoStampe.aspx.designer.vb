...
Partial Public Class WfrmElencoCronoStampe

    '''<summary>
    '''Controllo frmElencoCronoStampe.
    '''</summary>
    '''<remarks>
    '''Campo generato automaticamente.
    '''Per la modifica, spostare la dichiarazione di campo dal file di progettazione al file code-behind.
    '''</remarks>
    Protected WithEvents frmElencoCronoStampe As Global.System.Web.UI.HtmlControls.HtmlForm
