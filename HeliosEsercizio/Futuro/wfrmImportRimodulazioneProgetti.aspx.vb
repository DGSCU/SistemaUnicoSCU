...
Public Class wfrmImportRimodulazioneProgetti
    ...
    Private Sub CmdElabora_Click(ByVal sender As Object, ByVal e As EventArgs) Handles CmdElabora.Click
        ...
        If txtSelFile.PostedFile.FileName.ToString <> "" Then
            Try
                NomeUnivoco = "RimodulazioneCovid" & Session("IdEnte") & "_" & Session("Utente") & "_" & Year(Now) & Month(Now) & Day(Now) & Hour(Now) & Minute(Now) & Second(Now)
                Dim file As String
    ...
    Private Sub CreaTabTemp()
        ...
        '--- CREO TAB TEMPORANEA
        strSql = "CREATE TABLE [#TEMP_Rimodulazione] (" & _
    ...
    Private Sub LeggiCSV()
        ...
        While (xLinea <> "")
            ...
            If swErr = False Then
                ...
                ControlliImport(ArrCampi(2), ArrCampi(4), ArrCampi(6), ArrCampi(7), ArrCampi(8), ArrCampi(9), ArrCampi(10), ArrCampi(11), intEsito, strMessaggio)
        ...
        Reader.Close()
        Writer.Close()
        Response.Redirect("WfrmRisultatoImportRimodulazioneProgetti.aspx?NomeFile=" & NomeUnivoco & "&Tot=" & Tot & "&TotOk=" & TotOk & "&TotKo=" & TotKo)
    ...
    Private Sub ScriviTabTemp(ByVal pArray() As String)
        ...
        Try
            strsql = "INSERT INTO #TEMP_Rimodulazione " & _
                     "(CodiceProgetto, " & _
                     "TitoloProgetto, " & _
    ...
    Sub EsportazioneRimodulazione()
        ...
        myDataTable = ExecuteDataTable("SP_RimodulazionePROGETTI_EXPORT_SEDI", arrParam)
        myDataSet.Tables.Add(myDataTable)
        OutputXls("ExpRimodulazioneCovid", nomeFile)
    ...
    Public Sub TipoModalitàServizio()
        ...
        strSQL = "Select Descrizione, Codice From TipiModalitàServizio where rimodulazione = 1 and IdTipoEmergenza=1"
    ...
    Public Sub CodiceAttivitàRimodulazione()
        ...
        strSQL = "Select Descrizione, Codice From TipiAttivitàRimodulazione where rimodulazione = 1 and IdTipoEmergenza=1 order by len(codice),codice "
        dsTipoModalitàServizio = ClsServer.CreaDatareader(strSQL, Session("conn"))
        Response.Write("<fieldset>")
        Response.Write("<ul>")
        Do While dsTipoModalitàServizio.Read
    ...
    Private Sub ControlliImport(ByVal strCodiceProgetto As String, ByVal strCodiceSedeProgetto As String, ByVal strStatoRiattivazione As String, ByVal strModalitàServizio As String, strCodiceAttivitàRimodulazione As String, strAltro As String, strDataValidità As String, TipoEmergenza As String, ByRef intEsito As Integer, ByRef strMessaggio As String)
        ...
        Try
            SqlCmd.CommandText = "SP_RimodulazionePROGETTI_CONTROLLI_IMPORT"
