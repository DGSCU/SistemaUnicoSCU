<%@ Page Title="Documenti Progetto" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="wfrmDocumentiProgetto.aspx.vb" Inherits="Futuro.wfrmDocumentiProgetto" %>
    ...
    <script src="Scripts/JHelper.js" type="text/javascript"></script>
        <script type="text/javascript">
            ...
            function infoPrefissi() {
                window.open("wfrmInfoPrefissiDocumenti.aspx?IdAttivita=" + <%=Request.QueryString("IdAttivita")%> + "", "Elenco", "height=450,width=600,dependent=no,scrollbars=yes,status=no");
            }
		</script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<fieldset class="ContornoPagina">
<legend>Documenti Progetto</legend>
    ...
    <div class="collable" style="width:5%" >
            <asp:ImageButton  id="imgApplica" runat="server" style="cursor:hand" ImageUrl="images/Icona_Progetto_small.png"  ToolTip="Applica Progetto" AlternateText="Applica Progetto"/>
        </div>
    ...
    <asp:datagrid id="dtgAttivitaDocumenti" runat="server" Width="100%"  ToolTip="Elenco Documenti Esistenti" 
								...
								<Columns>
									...
									<asp:BoundColumn Visible="False" DataField="IdAttivit&#224;Documento"></asp:BoundColumn>
