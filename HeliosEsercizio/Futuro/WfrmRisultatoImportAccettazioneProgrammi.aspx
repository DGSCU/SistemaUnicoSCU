<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmRisultatoImportAccettazioneProgrammi.aspx.vb" Inherits="Futuro.WfrmRisultatoImportAccettazioneProgrammi" %>
...
<legend >Accettazione Programmi CSV</legend>
   
    <div class="headers">
        <h2>
            <asp:Label ID="Label5" runat="server" Text="Accettazione Programmi"></asp:Label>
        </h2>
    </div>
    <p>
