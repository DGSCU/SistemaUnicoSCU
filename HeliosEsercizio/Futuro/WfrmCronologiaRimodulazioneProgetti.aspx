<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WfrmCronologiaRimodulazioneProgetti.aspx.vb" Inherits="Futuro.WfrmCronologiaRimodulazioneProgetti" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Cronologia Dettaglio Rimodulazione</title>
...
<body>
    ...
    <legend> Dettagli  Rimodulazione</legend>
            <div class="wrapper" style="width:100%;border:0px">
             <h3>
                <asp:label id="lblsede"  runat="server" AssociatedControlID="dtgRisultatoRicerca" CssClass="msgInfo"  Text="Cronologia Rimodulazione SEDE "></asp:label>
            </h3>
