...
Imports System.IO
Public Class WfrmRisultatoImportAccettazioneProgrammi
    ...
    Private Sub CaricaGriglia()
        ...
        clCSV = New DataColumn
        clCSV.DataType = System.Type.GetType("System.String")
        clCSV.ColumnName = "Codice Programma"
        clCSV.Caption = "CodiceProgramma"
        clCSV.ReadOnly = False
        clCSV.Unique = False
        dtCSV.Columns.Add(clCSV)
    ...
    Private Sub CancellaTabellaTemp()
        ...
        Try
            ...
            strSql = "DROP TABLE [#TEMP_ACCETTAZIONE_PROGRAMMI]"
    ...
    'Private Sub RipristinoSedi(ByVal strCodiceProgramma As String, ByVal strTipoEsitoPositivo As String)
    ...
    '    'Try
    '    MyCommand.CommandText = "SP_PROGRAMMI_CONTROLLI_IMPORT_ACCETTAZIONE"
    ...
    '        MyCommand.Parameters.Add("@CodiceProgramma", SqlDbType.VarChar, 1000).Value = strCodiceProgramma
    ...
    '    Else
    '        MyCommand.Parameters("@CodiceProgramma").Value = strCodiceProgramma
    ...
    Private Sub ScriviAccettazioneProgrammi()
        Dim strsql As String
        Dim intX As Integer
        ...
        strsql = "INSERT INTO cronologiaprogrammi " & _
                 "(idprogramma,idstatoprogramma,datacronologia,idtipocronologia,usernameaccreditatore) " & _
                 "select b.idprogramma,b.idstatoprogramma,getdate(),0,'" & Session("Utente") & "'" & _
                 "FROM #TEMP_ACCETTAZIONE_PROGRAMMI a " & _
                 "INNER JOIN programmi b ON a.codiceprogramma = b.codiceprogramma "

        MyCommand.CommandText = strsql
        MyCommand.ExecuteNonQuery()

        strsql = "UPDATE programmi SET idstatoProgramma=3,dataultimostato=getdate(), usernamestato = '" & Session("Utente") & "'  " & _
         "FROM #TEMP_ACCETTAZIONE_PROGRAMMI a " & _
         "INNER JOIN programmi b ON a.codiceprogramma = b.codiceprogramma "
        MyCommand.CommandText = strsql
        MyCommand.ExecuteNonQuery()
    ...
    Protected Sub CmdChiudi_Click(sender As Object, e As EventArgs) Handles CmdChiudi.Click
        CancellaTabellaTemp()
        Response.Redirect("wfrmImportAccettazioneProgrammi.aspx")
    End Sub
End Class