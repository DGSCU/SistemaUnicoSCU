<%@ Page Language="vb" Title="Elenco Prefissi Documenti Rimborsi Viaggi" AutoEventWireup="false" CodeBehind="WfrmInfoPrefissiDocumentiRimborsi.aspx.vb" Inherits="Futuro.WfrmInfoPrefissiDocumentiRimborsi" %>
...
<head id="Head1" runat="server">
    ...
    <title>Elenco Prefissi Documenti Rimborsi Viaggi</title>
</head>
<body>
        ...
        <fieldset class="fieldsetrasparente">
            <div class="wrapper" style="width:100%;border:0px">
                <asp:datagrid id="dgElencoPrefissi" runat="server" Width="100%"  ToolTip="Elenco Prefissi Documenti" 
				    Caption="Elenco Prefissi Documenti Rimborsi Viaggi" AllowPaging="false" CellPadding="2" Font-Size="Small"  CssClass="table"  
