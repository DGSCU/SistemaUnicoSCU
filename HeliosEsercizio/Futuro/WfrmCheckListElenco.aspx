<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmCheckListElenco.aspx.vb" Inherits="Futuro.WfrmCheckListElenco" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset class="ContornoPagina">
        <legend>CHECK LIST ELENCO COLLETTIVO</legend>
<div class="wrapper" style="width:100%">
         ...
         <p></p>
         <asp:datagrid id="dgRisultatoRicerca" runat="server" Caption="Risultato Ricerca Elenco Paghe Collettivo"  CssClass="table" CellPadding="2" PageSize = "10"  AllowPaging="true" 	
