<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ricercavolontaripresenze.aspx.vb" Inherits="Futuro.ricercavolontaripresenze" %>
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent"></asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <fieldset class="ContornoPagina">
        <legend>Ricerca Volontari per Caricamento Presenze</legend>
        <div class="wrapper" style="width:100%">
            <div class="headers" >
               <h2><asp:Label ID="lblTitolo" runat="server"  Text="Ricerca Volontari Per Caricamento Presenze"></asp:Label></h2>
            </div>
