...
Public Class wfrmExportRiattivazione
    ...
    Protected Sub imgEsporta_Click(sender As Object, e As EventArgs) Handles imgEsporta.Click
        EsportazioneTotRiattivazione()
    End Sub

    Protected Sub CmdChiudi_Click(sender As Object, e As EventArgs) Handles CmdChiudi.Click
        Response.Redirect("WfrmMain.aspx")
    End Sub
    Sub EsportazioneTotRiattivazione()
        ...
        myDataTable = ExecuteDataTable("SP_RIATTIVAZIONE_STATO_CARICAMENTI", arrParam)
        myDataSet.Tables.Add(myDataTable)
        OutputXls("ExpTotaleRiattivazione", nomeFile)
        ...
        Else
            ...
            lblMessaggioErrore.Text = " Non risultano Progetti disponibili per Export Riattivazione"
    ...
    'Private Sub ddlSiNo_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlSiNo.SelectedIndexChanged
    '    hlVolontari.Visible = False
    '    imgEsporta.Visible = False
    'End Sub
End Class