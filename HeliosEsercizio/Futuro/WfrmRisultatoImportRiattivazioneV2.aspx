<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmRisultatoImportRiattivazioneV2.aspx.vb" Inherits="Futuro.WfrmRisultatoImportRiattivazioneV2" %>
...
<legend >Riattivazione Progetti CSV</legend>
   
    <div class="headers">
        <h2>
            <asp:Label ID="Label5" runat="server" Text="Riattivazione Progetti"></asp:Label>
        </h2>
    </div>
    <p>
