<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="wfrmInfoPrefissiDocumentiFormatore.aspx.vb" Inherits="Futuro.wfrmInfoPrefissiDocumentiFormatore" %>
    ...
    <fieldset class="fieldsetrasparente">
     <div class="wrapper" style="width:100%;border:0px">
        ...
        <asp:datagrid id="dgElencoPrefissi" runat="server" Width="100%"  ToolTip="Elenco Prefissi Documenti Volontario" 
				Caption="Elenco Prefissi Documenti Formatore" AllowPaging="false" CellPadding="2" Font-Size="Small"  CssClass="table"  
