...
Public Class crpOLPAttestato
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Futuro.crpOLPAttestato.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdCorso() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrpOLPAttestato
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpOLPAttestato = New crpOLPAttestato()
        rpt.Site = Me.Site
        Return rpt
    End Function
