...
Public Class crpValutQualNuovi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Futuro.crpValutQualNuovi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpValutQualNuovi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpValutQualNuovi = New crpValutQualNuovi()
        rpt.Site = Me.Site
        Return rpt
    End Function
