...
Public Class crpOLPAttestatoDett
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "crpOLPAttestatoDett.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Futuro.crpOLPAttestatoDett.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdCorsoDett() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrpOLPAttestatoDett
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpOLPAttestatoDett = New crpOLPAttestatoDett()
        rpt.Site = Me.Site
        Return rpt
    End Function
