...
Public Class crpProgettoSCN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Futuro.crpProgettoSCN.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_IdAttività() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedcrpProgettoSCN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpProgettoSCN = New crpProgettoSCN()
        rpt.Site = Me.Site
        Return rpt
    End Function
