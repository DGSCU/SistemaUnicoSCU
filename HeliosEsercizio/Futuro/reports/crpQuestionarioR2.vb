...
Public Class crpQuestionarioR2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Futuro.crpQuestionarioR2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrpQuestionarioR2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crpQuestionarioR2 = New crpQuestionarioR2()
        rpt.Site = Me.Site
        Return rpt
    End Function
