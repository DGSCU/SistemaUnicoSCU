<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmRisultatoImportValutazioneProgrammi.aspx.vb" Inherits="Futuro.WfrmRisultatoImportValutazioneProgrammi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<div class="firefox" >
        <fieldset class="ContornoPaginaScroll" >
            <legend>Importazione Valutazione Programmi</legend>
            <div class="headers">
                <h2><asp:Label ID="lblTitolo" runat="server"  Text="Importazione Valutazione Programmi"></asp:Label></h2>
            </div>
            <br />
