<%@ Page Title="Gestione Progetti" Language="vb" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TabProgetti.aspx.vb" Inherits="Futuro.TabProgetti" %>
     ...
     <script  type="text/javascript">
         ...
         function Salva() {
            ...
            <% End If %>
             if (document.getElementById(CostruisciId("CheckMonteOreTipo")) != null) {
                if (document.getElementById(CostruisciId("CheckMonteOreTipo")).value == 'selezionare' ) {
                 ...
                 if ((document.getElementById(CostruisciId("txtOreServizioSettimanali")).value == '') && (document.getElementById(CostruisciId("CheckMonteOreTipo")).value == '0')) {
                     messaggioDiErrore = "Sezione Progetto - Inserire almeno 30 ore di Servizio Settimanale.";
                     ConcatenaErrore(messaggioDiErrore, IdMsgErrore);
                     validazioneOk = false;
                 }
                 else {
                     if (document.getElementById(CostruisciId("CheckMonteOreTipo")).value == '0') {
                         if (parseInt(document.getElementById(CostruisciId("txtOreServizioSettimanali")).value) < 30) {
                             messaggioDiErrore = "Sezione Progetto - Inserire almeno 30 ore di Servizio Settimanale.";
                             ConcatenaErrore(messaggioDiErrore, IdMsgErrore);
                             validazioneOk = false;
                         }
                             ...
                             if (parseInt(document.getElementById(CostruisciId("txtOreServizioSettimanali")).value) > 255) {
                                 messaggioDiErrore = "Sezione Progetto - Il valore inserito %E8 superiore al numero massimo consentito.";
                                 ConcatenaErrore(messaggioDiErrore, IdMsgErrore);
                                 validazioneOk = false;
                             }
                         }
                         ...
                         if (parseInt(document.getElementById(CostruisciId("txtOreServizioSettimanali")).value) < 12) {
                             ...
                             if (parseInt(document.getElementById(CostruisciId("txtOreServizioSettimanali")).value) > 255) {
                                 messaggioDiErrore = "Sezione Progetto - Il valore inserito  delle ore settimanali %E8 superiore al numero massimo consentito.";
                                 ConcatenaErrore(messaggioDiErrore, IdMsgErrore);
                                 validazioneOk = false;
                             }
                         }
             ...
             if ('<%=request.querystring("Nazionale")%>' == '2') { //Estero
   ...
   <fieldset>
    <legend>Posti</legend>
     <div class="wrapper" style="width:100%;border:0px">
        ...
        <div  iD="divFAMI" class="row" runat="server" visible="false">
             <div class="collable" style="width:10%">
                <asp:Label ID="LblFami" AssociatedControlID="chkFami" Text="FAMI" CssClass="label" runat="server"></asp:Label>
            </div>
            <div class="collable" style="width:10%">
                <asp:CheckBox id="chkFami" Runat="server" AutoPostBack="true" ></asp:CheckBox>          
            </div>
            <div class="collable" style="width:10%">
                <asp:Label ID="lblNumeroVolontariFami" AssociatedControlID="txtNumeroVolontariFami" Text="Numero Vol. FAMI" CssClass="label" runat="server" Visible="false"></asp:Label>
            </div>
            <div class="colOggetti" style="width:10%">
                <asp:TextBox ID="txtNumeroVolontariFami" Enabled="false" runat="server" CssClass="textbox" Visible="false"  ></asp:TextBox>
            </div>
            <div class="collable" style="width:60%">
                <asp:Label ID="LblInfoFami" Text="Si ricorda l'obbligo di prevedere l’erogazione di un modulo formativo dedicato, della durata di 10 ore." CssClass="label" runat="server" Visible="false"></asp:Label>
            </div
        </div>
    </div>
   </fieldset>
   ...
   <fieldset id="fieldSetPostiRichiesti" runat="server" style="height:auto">
    <legend>Posti Richiesti</legend>
     <div class="wrapper" style="width:100%;border:0px">
        ...
        <div ID="divFAMIRic" class="row" runat="server" visible="false">
            <div class="collable" style="width:10%">
                <asp:Label ID="lblNumeroVolontariFamiRic" AssociatedControlID="txtNumeroVolontariFamiRic" Text="Numero Vol. FAMI" CssClass="label" runat="server"></asp:Label>
            </div>
            <div class="colOggetti" style="width:10%">
                <asp:TextBox ID="txtNumeroVolontariFamiRic" Enabled="false" runat="server" CssClass="textbox"  ></asp:TextBox>
            </div>
        </div>
    </div>
   </fieldset>
