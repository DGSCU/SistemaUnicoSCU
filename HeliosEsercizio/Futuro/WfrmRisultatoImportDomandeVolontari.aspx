<%@ Page Title="Risultato Importazione File di Domande Ricevute" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmRisultatoImportDomandeVolontari.aspx.vb" Inherits="Futuro.WfrmRisultatoImportDomandeVolontari" %>
...
<legend>Risultati importazione Domande Ricevute</legend>


    <div class="headers">
    <h2>
   
       <asp:Label ID="Label5" runat="server"  Text="Import Numero Domande Ricevute"></asp:Label>
