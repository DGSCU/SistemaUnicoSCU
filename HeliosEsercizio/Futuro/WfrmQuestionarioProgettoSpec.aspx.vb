...
Public Class WfrmQuestionarioProgettoSpec
...
#End Region
    ...
    Private Sub PopolaMaschera(ByVal idbando As Integer)
        ...
        strsql = strsql & "QuestionariostoricoProgetti.noteStorico, "
        strsql = strsql & "QuestionariostoricoProgetti.NumeroFormatori, "
        strsql = strsql & "QuestionariostoricoProgetti.NumeroVolontari, "
        strsql = strsql & "QuestionariostoricoProgetti.EnteFormatore, "
        strsql = strsql & "QuestionarioStoricoNote.MotivazioniCambio, "
        ...
        strsql = strsql & "QuestionariostoricoProgetti.NumeroFormatoriVolontariM, "
        strsql = strsql & "QuestionariostoricoProgetti.NumeroFormatoriVolontariF, "
        strsql = strsql & "QuestionariostoricoProgetti.NumeroFormatoriContrattoM, "
        strsql = strsql & "QuestionariostoricoProgetti.NumeroFormatoriContrattoF, "
        strsql = strsql & "QuestionariostoricoProgetti.NumeroFormatoriDipendentiM, "
        strsql = strsql & "QuestionariostoricoProgetti.NumeroFormatoriDipendentiF, "
        strsql = strsql & "QuestionariostoricoProgetti.NumeroFormatoriCorso, "
        strsql = strsql & "QuestionarioStoricoNote.PuntiForza, "
        strsql = strsql & "QuestionarioStoricoNote.Criticità, "
        ...
        strsql = strsql & "QuestionarioStoricoNote.DifficoltàAdeguamento, "
        strsql = strsql & "QuestionarioStoricoNote.MotiviModificaAree, "
        strsql = strsql & "QuestionarioStoricoNote.MotiviRafforzamentoAree "
        ...
        strsql = strsql & " inner join QuestionarioStoricoNote on (QuestionarioStoricoNote.idStorico=QuestionariostoricoProgetti.idStorico) "
        strsql = strsql & " inner join BandiAttività ON QuestionarioStoricoProgetti.IdBandoAttività = BandiAttività.IdBandoAttività "
        strsql = strsql & " where idbando=" & idbando & " And idente=" & Session("idente")
        ...
        Do While dtrgenerico.Read
            For s = 1 To j
                ...
                txtSeSiQuali.Text = IIf(Not IsDBNull(dtrgenerico("noteStorico")), dtrgenerico("notestorico"), "")
                txtNumFormatori.Text = IIf(Not IsDBNull(dtrgenerico("NumeroFormatori")), dtrgenerico("NumeroFormatori"), "0")
                txtNumVolontari.Text = IIf(Not IsDBNull(dtrgenerico("NumeroVolontari")), dtrgenerico("NumeroVolontari"), "0")
                txtDenominazioneEnte.Text = IIf(Not IsDBNull(dtrgenerico("EnteFormatore")), dtrgenerico("EnteFormatore"), "")
                txtMotivazioniCambiamentoEnte.Text = IIf(Not IsDBNull(dtrgenerico("MotivazioniCambio")), dtrgenerico("MotivazioniCambio"), "")
                ...
                txtNumeroFormatoriVolontariM.Text = IIf(Not IsDBNull(dtrgenerico("NumeroFormatoriVolontariM")), dtrgenerico("NumeroFormatoriVolontariM"), "0")
                txtNumeroFormatoriVolontariF.Text = IIf(Not IsDBNull(dtrgenerico("NumeroFormatoriVolontariF")), dtrgenerico("NumeroFormatoriVolontariF"), "0")
                txtNumeroFormatoriAContrattoM.Text = IIf(Not IsDBNull(dtrgenerico("NumeroFormatoriContrattoM")), dtrgenerico("NumeroFormatoriContrattoM"), "0")
                txtNumeroFormatoriAContrattoF.Text = IIf(Not IsDBNull(dtrgenerico("NumeroFormatoriContrattoF")), dtrgenerico("NumeroFormatoriContrattoF"), "0")
                txtNumeroFormatoriDipendentiM.Text = IIf(Not IsDBNull(dtrgenerico("NumeroFormatoriDipendentiM")), dtrgenerico("NumeroFormatoriDipendentiM"), "0")
                txtNumeroFormatoriDipendentiF.Text = IIf(Not IsDBNull(dtrgenerico("NumeroFormatoriDipendentiF")), dtrgenerico("NumeroFormatoriDipendentiF"), "0")
                ...
                txtPuntiDiForza.Text = IIf(Not IsDBNull(dtrgenerico("PuntiForza")), dtrgenerico("PuntiForza"), "")
                txtCriticita.Text = IIf(Not IsDBNull(dtrgenerico("Criticità")), dtrgenerico("Criticità"), "")
                ...
                txtDifficoltaAdeguamento.Text = IIf(Not IsDBNull(dtrgenerico("DifficoltàAdeguamento")), dtrgenerico("DifficoltàAdeguamento"), "")
                txtMotiviModificaAree.Text = IIf(Not IsDBNull(dtrgenerico("MotiviModificaAree")), dtrgenerico("MotiviModificaAree"), "")
                txtMotiviRafforzamentoAree.Text = IIf(Not IsDBNull(dtrgenerico("MotiviRafforzamentoAree")), dtrgenerico("MotiviRafforzamentoAree"), "")
            Next
        Loop
        dtrgenerico.Close()
        dtrgenerico = Nothing
    ...
    Private Sub cmdConferma_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles cmdConferma.Click
        ...
        For iAtt = 0 To dtBandoAttivita.Rows.Count - 1
            ...
            strsql = strsql & "NumeroFormatoriVolontariM, "
            strsql = strsql & "NumeroFormatoriVolontariF, "
            strsql = strsql & "NumeroFormatoriContrattoM, "
            strsql = strsql & "NumeroFormatoriContrattoF, "
            strsql = strsql & "NumeroFormatoriDipendentiM, "
            strsql = strsql & "NumeroFormatoriDipendentiF, "
            ...
            strsql = strsql & "'" & Replace(txtSeSiQuali.Text, "'", "''") & "', "
            strsql = strsql & txtNumFormatori.Text & ", "
            strsql = strsql & txtNumVolontari.Text & ", "
            ...
            strsql = strsql & txtNumeroFormatoriVolontariM.Text & ", "
            strsql = strsql & txtNumeroFormatoriVolontariF.Text & ", "
            strsql = strsql & txtNumeroFormatoriAContrattoM.Text & ", "
            strsql = strsql & txtNumeroFormatoriAContrattoF.Text & ", "
            strsql = strsql & txtNumeroFormatoriDipendentiM.Text & ", "
            strsql = strsql & txtNumeroFormatoriDipendentiF.Text & ", "
            ...
            strsql = strsql & txtLezioneFrontale.Text & ", "
            strsql = strsql & txtDinamicheNonFormali.Text & ", "
            strsql = strsql & txtFormazioneADistanza.Text & ","
            ...
            strsql = "INSERT INTO QuestionarioStoricoNote "
            strsql = strsql & "(IdStorico, "
            strsql = strsql & "MotivazioniCambio, "
            strsql = strsql & "PuntiForza, "
            strsql = strsql & "Criticità, "
            strsql = strsql & "DifficoltàAdeguamento, "
            strsql = strsql & "MotiviModificaAree, "
            strsql = strsql & "MotiviRafforzamentoAree) "
            strsql = strsql & "VALUES "
            strsql = strsql & "(" & idStorico & ", "
            strsql = strsql & "'" & Replace(txtMotivazioniCambiamentoEnte.Text, "'", "''") & "', "
            strsql = strsql & "'" & Replace(txtPuntiDiForza.Text, "'", "''") & "', "
            strsql = strsql & "'" & Replace(txtCriticita.Text, "'", "''") & "', "
            strsql = strsql & "'" & Replace(txtDifficoltaAdeguamento.Text, "'", "''") & "', "
            strsql = strsql & "'" & Replace(txtMotiviModificaAree.Text, "'", "''") & "', "
            strsql = strsql & "'" & Replace(txtMotiviRafforzamentoAree.Text, "'", "''") & "') "
    ...
    Private Sub cmdStampaVQ_Click(ByVal sender As Object, ByVal e As EventArgs) Handles cmdStampaVQ.Click
        ...
        strsql = "SELECT isnull(Max(IdStorico),0) as MaxIdS FROM  QuestionarioStoricoProgetti INNER JOIN " & _
        ...
        Else
            ...
            Response.Write("window.open('WfrmReportistica.aspx?sTipoStampa=29&IdBando=" & Session("idbando") & "&IdStorico=" & iMaxId & "','report','height=800,width=800,dependent=no,scrollbars=no,status=no,resizable=yes');" & vbCrLf)
    ...
    Private Sub ImpostaCampiInSolaLettura(ByVal solaLettura As Boolean)
        txtSeSiQuali.ReadOnly = solaLettura
        txtNumFormatori.ReadOnly = solaLettura
        txtNumVolontari.ReadOnly = solaLettura
        txtDenominazioneEnte.ReadOnly = solaLettura
        txtMotivazioniCambiamentoEnte.ReadOnly = solaLettura
        txtNumeroFormatoriM.ReadOnly = solaLettura
        txtNumeroFormatoriF.ReadOnly = solaLettura
        txtNumeroFormatoriDiplomati.ReadOnly = solaLettura
        txtNumeroFormatoriLaureati.ReadOnly = solaLettura
        txtNumeroFormatoriVolontariM.ReadOnly = solaLettura
        txtNumeroFormatoriVolontariF.ReadOnly = solaLettura
        txtNumeroFormatoriAContrattoM.ReadOnly = solaLettura
        txtNumeroFormatoriAContrattoF.ReadOnly = solaLettura
        txtNumeroFormatoriDipendentiM.ReadOnly = solaLettura
        txtNumeroFormatoriDipendentiF.ReadOnly = solaLettura
        txtNumeroFormatoriCheHannoFrequentato.ReadOnly = solaLettura
        txtPuntiDiForza.ReadOnly = solaLettura
        txtCriticita.ReadOnly = solaLettura
        txtNumeroVolontariDelVostroEnte.ReadOnly = solaLettura
        txtNumeroVolontariAltriEnti.ReadOnly = solaLettura
        txtLezioneFrontale.ReadOnly = solaLettura
        txtDinamicheNonFormali.ReadOnly = solaLettura
        txtFormazioneADistanza.ReadOnly = solaLettura
        txtDifficoltaAdeguamento.ReadOnly = solaLettura
        txtMotiviModificaAree.ReadOnly = solaLettura
        txtMotiviRafforzamentoAree.ReadOnly = solaLettura
    End Sub
    Private Function ValidaDati() As Boolean
        ...
        If (Integer.TryParse(txtNumVolontari.Text, numeroVolontari) = False Or numeroVolontari = 0) Then
            ...
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroFormatoriM.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formatori uomini valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroFormatoriF.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formatori donne valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroFormatoriDiplomati.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formatori diplomati valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroFormatoriLaureati.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formatori laureati valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroFormatoriVolontariM.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formatori volontari uomini valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroFormatoriVolontariF.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formatori volontari donne valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroFormatoriAContrattoM.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formatori a contratto uomini valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroFormatoriAContrattoF.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formatori a contratto donne valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroFormatoriDipendentiM.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formatori dipendenti dall'ente uomini valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroFormatoriDipendentiF.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formatori dipendenti dall'ente donne valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroFormatoriCheHannoFrequentato.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formatori che hanno frequentato il corso formatori organizzato da UNSC o Regione valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroVolontariDelVostroEnte.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di volontari del vostro ente valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtNumeroVolontariAltriEnti.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di volontari altro ente valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtLezioneFrontale.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di lezione frontale valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtDinamicheNonFormali.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di dinamiche non formali valido.</br>"
            validazioneOk = False
        End If
        If (Integer.TryParse(txtFormazioneADistanza.Text, numeroIntero) = False) Then
            lblerrore.Text = lblerrore.Text + "Inserire un numero di formazione a distanza valido.</br>"
            validazioneOk = False
        End If
