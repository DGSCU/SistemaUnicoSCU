<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="wfrmRisultatoImportasse2bis.aspx.vb" Inherits="Futuro.wfrmRisultatoImportasse2bis" %>
...
<legend >Volontari Asse 1Bis CSV</legend>
    <div class="headers">
        <h2>
            <asp:Label ID="Label5" runat="server" Text="Volontari Asse 1Bis"></asp:Label>
        </h2>
    </div>
    <p>
