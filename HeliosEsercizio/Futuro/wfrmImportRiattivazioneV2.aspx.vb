...
Public Class wfrmImportRiattivazioneV2
    ...
    Private Sub CmdElabora_Click(ByVal sender As Object, ByVal e As EventArgs) Handles CmdElabora.Click
        ...
        If txtSelFile.PostedFile.FileName.ToString <> "" Then
            Try
                NomeUnivoco = "Riattivazione" & Session("IdEnte") & "_" & Session("Utente") & "_" & Year(Now) & Month(Now) & Day(Now) & Hour(Now) & Minute(Now) & Second(Now)
                Dim file As String
    ...
    Private Sub CreaTabTemp()
        ...
        '--- CREO TAB TEMPORANEA
        strSql = "CREATE TABLE [#TEMP_COVID19_V2] (" & _
                 ...
                 "[NumeroVolontariConConsenso] [varchar] (1000) COLLATE DATABASE_DEFAULT, " & _
                 "[CodiceNuovaSedeAccreditata] [varchar] (1000) COLLATE DATABASE_DEFAULT, " & _
                 "[NuovaSedeSvolgimentoNonAccreditata] [varchar] (8000) COLLATE DATABASE_DEFAULT, " & _
                 ...
                 "[DataRipresaServizio] [varchar] (1000) COLLATE DATABASE_DEFAULT, " & _
    ...
    Private Sub LeggiCSV()
        ...
        While (xLinea <> "")
            ...
            If swErr = False Then
                ...
                ControlliImport(ArrCampi(0), ArrCampi(2), ArrCampi(4), ArrCampi(5), ArrCampi(6), ArrCampi(7), ArrCampi(8), ArrCampi(9), ArrCampi(10), ArrCampi(11), intEsito, strMessaggio)
        ...
        Reader.Close()
        Writer.Close()
        Response.Redirect("WfrmRisultatoImportRiattivazioneV2.aspx?NomeFile=" & NomeUnivoco & "&Tot=" & Tot & "&TotOk=" & TotOk & "&TotKo=" & TotKo)
    ...
    Private Sub ScriviTabTemp(ByVal pArray() As String)
        ...
        Try
            strsql = "INSERT INTO #TEMP_COVID19_V2 " & _
                     "(CodiceProgetto, " & _
                     "Titolo, " & _
                     ...
                     "ModalitàServizio, " & _
                     "NumeroVolontariconConsenso, " & _
                     "CodiceNuovaSedeAccreditata," & _
                     "NuovaSedeSvolgimentoNonAccreditata," & _
    ...
    Sub EsportazioneCovid19()
        ...
        myDataTable = ExecuteDataTable("SP_RIATTIVAZIONE_EXPORT_SEDI", arrParam)
        myDataSet.Tables.Add(myDataTable)
        OutputXls("ExpRiattivazione", nomeFile)
        ...
        Else
            lblMessaggioErrore.Visible = True
            lblMessaggioErrore.Text = " Non risultano Progetti disponibili per la Riattivazione"
    ...
    Public Sub StatiRiattivazione()
        ...
        strSQL = "Select Descrizione, Codice From StatiRiattivazione"
    ...
    Public Sub TipoModalitàServizio()
        ...
        strSQL = "Select Descrizione, Codice From TipiModalitàServizio "
    ...
    Public Sub CodiceAttivitàRimodulazione()
        ...
        strSQL = "Select Descrizione, Codice From TipiAttivitàRimodulazione where riattivazione = 1 order by len(codice), codice "
        dsTipoModalitàServizio = ClsServer.CreaDatareader(strSQL, Session("conn"))
        Response.Write("<fieldset>")
        Response.Write("<ul>")
        Do While dsTipoModalitàServizio.Read
    ...
    Private Sub ControlliImport(ByVal strCodiceProgetto As String, ByVal strCodiceSedeProgetto As String, ByVal strStatoRiattivazione As String, ByVal strModalitàServizio As String, ByVal strNumeroVolontariConConsenso As String, ByVal strCodiceNuovaSedeAccreditata As String, ByVal strDescrizioneNuovaSede As String, strCodiceAttivitàRimodulazione As String, strAltro As String, strDataRipresaServizio As String, ByRef intEsito As Integer, ByRef strMessaggio As String)
        ...
        Try
            SqlCmd.CommandText = "SP_RIATTIVAZIONE_CONTROLLI_IMPORT_V2"
            ...
            SqlCmd.Parameters.Add("@NumeroVolontariConConsenso", SqlDbType.VarChar, 1000).Value = strNumeroVolontariConConsenso
            SqlCmd.Parameters.Add("@CodiceNuovaSedeAccreditata", SqlDbType.VarChar, 1000).Value = strCodiceNuovaSedeAccreditata
            SqlCmd.Parameters.Add("@DescrizioneNuovaSede", SqlDbType.VarChar, 1000).Value = strDescrizioneNuovaSede
            ...
            SqlCmd.Parameters.Add("@DataRipresaServizio", SqlDbType.VarChar, 1000).Value = strDataRipresaServizio
