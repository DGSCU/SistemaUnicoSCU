<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="wfrmExportRimodulazioneProgetti.aspx.vb" Inherits="Futuro.wfrmExportRimodulazioneProgetti" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<fieldset class="ContornoPagina">
        <legend>Esportazione File Rimodulazione Progetti</legend>
        <div id="TabellaImportAssenzeVolontari" class="wrapper" style="width: 100%">
            <div class="headers">
                <h2>
                    <asp:Label ID="Label5" runat="server" Text="Export File Rimodulazione Progetti"></asp:Label>
                </h2>
            </div>
            <div class="RigaVuota">
                &nbsp;</div>
           ...
           <div class="collable" style="width:25%">
            ...
            <div class="row">
                ...
                <asp:Label CssClass="label" ID="Label2" runat="server" Width="330px" Text="Esportare il file Rimodulazione Progetti   .csv"></asp:Label>
