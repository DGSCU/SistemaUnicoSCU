<%@ Page Title="Ricerca Volontari per Caricamento Documenti" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="ricercavolontaridocumenti.aspx.vb" Inherits="Futuro.RicercaVolontariDocumenti" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <fieldset class="ContornoPagina">
        <legend>Ricerca Volontari per Caricamento Documenti</legend>
        <div class="wrapper" style="width:100%">
            <div class="headers" >
               <h2><asp:Label ID="lblTitolo" runat="server"  Text="Ricerca Volontari Per Caricamento Documenti"></asp:Label></h2>
            </div>
            ...
            <div class="row" >
             ...
             <div  class="row">
                <div class="collable" style="width:15%">      
                    <asp:Label ID="LblDoc" CssClass="label" AssociatedControlID="ddlPrefissiDocumenti" runat="server" Text="Volontari senza documenti caricati:"></asp:Label>
                </div>
                <div class="colOggetti" style="width:35%">       
                ...
                <div class="collable" style="width:15%">      
                    <asp:Label ID="lblfami" AssociatedControlID="ddlFami" ToolTip="Fami" runat="server" Text="FAMI"></asp:Label>
                </div>
                <div class="colOggetti" style="width:35%">       
                     <asp:DropDownList ID="ddlFami"  CssClass="ddlClass" runat="server">
    ...
    <asp:datagrid id="dgVolontari" runat="server" Width="100%" 
		...
		<Columns>
			...
			<asp:TemplateColumn HeaderText="Selez.">
                <ItemTemplate>
					<asp:ImageButton ID="imgDocVol" CommandName="Consulta" ToolTip="Consulta Documenti Volontario" AlternateText="Consulta Documenti Volontario" runat="server" ImageURL="images/Icona_Volontario_small.png" CausesValidation="false"></asp:ImageButton>                         
                </ItemTemplate>            
            </asp:TemplateColumn>
			...
			<asp:BoundColumn DataField="datainizioservizio" 
                HeaderText="Data Inizio Servizio">
			</asp:BoundColumn>
