Imports System.IO
Public Class WfrmCheckListElencoInidividuale
    ...
    Private Sub RicercaElencoLista()
        ...
        Dim strNomeStore As String = "[SP_CHECKLIST_RICERCA_INDIVIDUALE]"
        ...
        Try
            ...
            sqlDAP.SelectCommand.Parameters.Add("@CodiceProgettoRendicontazione", SqlDbType.VarChar).Value = CboCodProgRend.SelectedValue.Replace("'", "''")
    ...
    Function CreaFileCSV(ByVal DTBRicerca As DataTable, ByVal xPrefissoNome As String, ByVal mapPath As String) As String
        ...
        Dim url As String
        NomeUnivoco = xPrefissoNome & "ExpDatiIndividuale" & Year(Now) & Month(Now) & Day(Now) & Hour(Now) & Minute(Now) & Second(Now)
