...
#Region " Dichiarazione Variabii"
    ...
    Dim intIDAmbitoAttivitàSecondario As Integer
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Else
            TipoEnte.Value = "NO"
        End If
        If chkAltroEnte.Checked = True Then
            txtcodNZ.Visible = True
        Else
            txtcodNZ.Visible = False
        End If
        ...
        If Request.QueryString("IdAttivita") <> "" Then
            ...
            txtIdAreaSecondaria.Value = strIdAmbitiSecondariModifica.Value
            txtCodAttivitaSec.Value = txtCodAttivitaSec.Value
            ...
            If chkVisualizzazione.Value = VALORE_TRUE Then
                ...
                ddlAreaSecondaria.Enabled = False
        ...
        Else
            ...
            If dtrStato.HasRows = False Then
                ...
                lblerrore.Text = "L'ente non è abilitato all'inserimento di progetti."
                InVisualizzazione()
        ...
        If Page.IsPostBack = False Then
            ...
            Select Case Request.QueryString("Nazionale")
                ...
                Case 11, 4
                    chkCoProgettato.Visible = True
                    imgCoProgettazione.Visible = True
                    tipoprog2020.Text = "Nazionale 2020"
                    DivMisureAggiuntive.Visible = True
                    divEsteroTutoraggio.Visible = True
                    If Request.QueryString("IdAttivita") <> "" Then
                        'carico le griglie 
                ...
                Case 12
                    ...
                    End If
                    lblSezioneEsteroNonPresente.Visible = False
                    'lblCondizioniRischio.Visible = False
                    'ddlCondizioniRischio.Visible = False
                    'ddlLivelliSicurezza.Visible = False
                    'lblLivelliSicurezza.Visible = False
                    'lblCondizioniDisagio.Visible = False
                    'ddlCondizioniDisagio.Visible = False
                    'ddlAreaSecondaria.Visible = False 'vedo combo areasecondaria
                    'lblAreaSecondaria.Visible = False
            End Select
            ...
            If Not Request.QueryString("IdAttivita") Is Nothing Then
                ...
                If Session("TipoUtente") = "U" Or Session("TipoUtente") = "R" Then
                    ...
                    'End If
                    ImgStampa.Visible = False 'tolta visibilità perché report esistente non adeguato a nuova scheda 2020
                Else
                    ImgStampa.Visible = False
    ...
    Private Sub cmdSalva_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles cmdSalva.Click
        ...
        If (ValidaCampi()) Then
            ...
            If Not Request.QueryString("IdAttivita") Is Nothing Then
                ...
                strIdAmbitiSecondariModifica.Value = txtIdAreaSecondaria.Value
                ...
                txtCodAttivitaSec.Value = txtCodAttSec.Value
            ...
            Else
                ...
                Response.Redirect("TabProgetti2020.aspx?CheckMess=True&Nazionale=" & Request.QueryString("Nazionale") & "&Modifica=" & "1" & "&IdAttivita=" & intMaxIdInserimento & "")
            End If
        End If
        CalcolaTotaleOreTutoraggio()
    End Sub
    ...
    Sub CaricaProgetto(ByVal IdAttivita As Integer, ByVal Visualizzazione As Integer)
        ...
        Dim myCommand As New System.Data.SqlClient.SqlCommand
        Dim strsql As String
        Dim IdEnteReferenteProgramma As Integer
        Dim IDEntePresentante As Integer
        'chiudo le operazioni sugli ambiti 
        ReDim Session("VOperazioniAmbiti")(0)
        Session("VOperazioniAmbiti")(0) = ""
        Dim settoreSec As Integer
        ...
        strsql = "select a.IDAttività, a.Titolo, a.CodiceEnte, a.IDEntePresentante, ISNULL(A.DATAINIZIOATTIVITà,A.DATAINIZIOPREVISTA) AS DataInizioPrevista, a.NumeroPostiNoVittoNoAlloggio, " & _
                 "a.NumeroPostiVittoAlloggio, a.NumeroPostiVitto, a.IDAmbitoAttività,a.IDAmbitoAttivitàSecondario,a.NumeroPostiNoVittoNoAlloggioRic,a.NumeroPostiVittoAlloggioRic, a.NumeroPostiVittoRic, " & _
                 ...
                 "a.EsteroUE, a.NMesiEsteroUE, a.NGiorniEsteroUE, a.Transfrontaliero, a.ModalitàTransfrontaliero, a.Tutoraggio, a.NMesiTutoraggio, a.NGiorniTutoraggio, b.Partners, a.IdEnteReferenteProgramma, isnull(programmi.titolo,'non associato') as TitoloProgramma, (convert(varchar(10),a.IdAmbitoAttività) + '|' + g.Codifica + ' - ' + g.AmbitoAttività)  as IDCodSec, a.DescrizioneDisabilità, a.NumeroOreCollettive, a.NumeroOreIndividuali, programmi.codiceprogramma, programmi.idprogramma " & _
                 ...
                 "left join Programmi on a.idprogramma = programmi.idprogramma " & _
        ...
        Try
            ...
            If dtrLocal.HasRows = True Then
                ...
                'Antonello 12/01/2021
                If IsDBNull(dtrLocal("IDAmbitoAttivitàSecondario")) = False Then
                    'stampo a pagina l'id dell'IDAmbitoAttivitàSecondario
                    txtCodAttivitaSec.Value = dtrLocal("IDCodSec")
                    txtIdAreaSecondaria.Value = dtrLocal("IDAmbitoAttivitàSecondario")
                    intIDAmbitoAttivitàSecondario = CInt(dtrLocal("IDAmbitoAttivitàSecondario"))
                Else
                    'stampo a pagina l'id dell'IDAmbitoAttivitàSecondario
                    txtCodAttivitaSec.Value = dtrLocal("IDCodSec")
                    '    'nel caso in cui non ci fosse id IDAmbitoAttivitàSecondario
                    txtIdAreaSecondaria.Value = "0"
                    intIDAmbitoAttivitàSecondario = 0
                End If



                'Antonello 25/11/2019
                ...
                Else
                    txtTitolo.Text = ""
                End If
                If IsDBNull(dtrLocal("TitoloProgramma")) = False Then
                    txtTitoloProgramma.Text = dtrLocal("TitoloProgramma")
                Else
                    txtTitoloProgramma.Text = "non associato"
                End If
                If IsDBNull(dtrLocal("CodiceProgramma")) = False Then
                    txtCodiceDelProgramma.Text = dtrLocal("CodiceProgramma")
                Else
                    txtCodiceDelProgramma.Text = ""
                End If
                If IsDBNull(dtrLocal("idProgramma")) = False Then
                    idprogramma.Value = dtrLocal("idProgramma")
                ...
                Select Case Request.QueryString("Nazionale")
                    ...
                    Case "9", "11", "4"  ' SCU Italia con misure aggiuntive
                        If dtrLocal("GiovaniMinoriOpportunità") = True Then
                            ...
                            If Not IsDBNull(dtrLocal("NumeroGiovaniMinoriOpportunità")) Then txtNumeroGiovaniMinoriOpportunita.Text = dtrLocal("NumeroGiovaniMinoriOpportunità")
                            ddlCategoriaMO.SelectedValue = dtrLocal("IDParticolaritàEntità")
                            'ADC 10/12/2021
                            If ddlCategoriaMO.SelectedValue = 5 Then
                                lbltipodisabilità.Visible = True
                                txttipodis.Visible = True
                                If Not IsDBNull(dtrLocal("DescrizioneDisabilità")) Then txttipodis.Text = dtrLocal("DescrizioneDisabilità")
                            End If
                            CalcolaPercentualeGMO()
                        End If
                        ...
                        If dtrLocal("Tutoraggio") = True Then
                            ...
                            'prova 
                            txtorecollettive.Text = ""
                            txtoreindividuali.Text = ""
                            ...
                            If Not IsDBNull(dtrLocal("NumeroOreCollettive")) Then txtorecollettive.Text = dtrLocal("NumeroOreCollettive")
                            If Not IsDBNull(dtrLocal("NumeroOreIndividuali")) Then txtoreindividuali.Text = dtrLocal("NumeroOreIndividuali")
                            DivTutoraggio.Visible = True
                            CalcolaTotaleOreTutoraggio()

                        End If

                    Case "10", "12" ' SCU Estero con misure aggiuntive
                        If Not IsDBNull(dtrLocal("NMesiEsteroUE")) Then txtNumeroMesiEstero.Text = dtrLocal("NMesiEsteroUE")
                ...
                If IsDBNull(dtrLocal("Partners")) = False Then
                    Select Case dtrLocal("Partners")
                        Case "0" 'NO
                            ddlPartner.SelectedValue = 0
                        Case "1" 'SI
                            ddlPartner.SelectedValue = 1
                    End Select
                End If

                If IsDBNull(dtrLocal("RequisitiVolontari")) = False Then
                    Select Case dtrLocal("RequisitiVolontari")
                        Case "0" 'NO
                            ddlRequisitiVolontari.SelectedValue = 0
                        Case "1" 'SI
                            ddlRequisitiVolontari.SelectedValue = 1
                    End Select
                End If


                If Request.QueryString("Nazionale") = 11 Or Request.QueryString("Nazionale") = 12 Or Request.QueryString("Nazionale") = 4 Then
                    IdEnteReferenteProgramma = dtrLocal("IdEnteReferenteProgramma")
                    IDEntePresentante = dtrLocal("IDEntePresentante")
                    If IDEntePresentante = IdEnteReferenteProgramma Then
                        chkEnteProponente.Checked = True
                    Else
                        chkAltroEnte.Checked = True
                    End If
                End If
                '
                ' COMMENTATO ZORRO
                ...
                Else
                    ...
                    'CaricaComboAreaSecondariaPrimaVolta()
                End If
                '12/01/2021 Antonello
                ChiudiDataReader(dtrLocal)

                strCaricaProgetto = "select (convert(varchar(10),ambitiattività.IdAmbitoAttività) + '|' + ambitiattività.Codifica + ' - ' + ambitiattività.AmbitoAttività) as IDCodSec,ambitiattività.IdMacroAmbitoAttività as IdMacroAmbitoAttivita ,ambitiattività.AmbitoAttività as AmbitoAttivita,(ambitiattività.Codifica + ' - ' + ambitiattività.AmbitoAttività) as AreeSec, ambitiattività.IDAmbitoAttività as IDAmbitoAttivitaSecondario, "
                strCaricaProgetto = strCaricaProgetto & " (macroambitiattività.Codifica + ' - ' + macroambitiattività.MacroAmbitoAttività) as Settore1"
                strCaricaProgetto = strCaricaProgetto & " from ambitiattività "
                strCaricaProgetto = strCaricaProgetto & " join macroambitiattività  on ambitiattività.IdMacroAmbitoAttività=macroambitiattività.IdMacroAmbitoAttività "
                strCaricaProgetto = strCaricaProgetto & " where(ambitiattività.IdAmbitoAttività = " & intIDAmbitoAttivitàSecondario & ")"
                'eseguo la query
                myCommand.CommandText = strCaricaProgetto
                dtrLocal = myCommand.ExecuteReader
                'leggo il datareader
                ...
                If dtrLocal.HasRows = True Then
                    Dim settore1 As Int32 = CInt(dtrLocal("IdMacroAmbitoAttivita"))
                    'txtAreaPrincipale.Text = dtrLocal("Aree")

                    Dim AmbitoAttivitaSecondario = dtrLocal("IDCodSec")
                    ChiudiDataReader(dtrLocal)
                    CaricaComboAreaSecondaria(settore1)
                    ddlAreaSecondaria.SelectedValue = AmbitoAttivitaSecondario
                Else
                    ChiudiDataReader(dtrLocal)
                    CaricaComboAreaSecondaria(settoreSec)
                    ddlAreaSecondaria.SelectedValue = "0"
                End If



                'CARICARE AMBITO SECONDARIO  Antonello 12/01/2021
                ...
                If dtrLocal.HasRows = True Then
                    Do While dtrLocal.Read
                        ...
                        'txtArea.Text = txtArea.Text & dtrLocal("Denominazione") & vbCrLf 'ZORRO
        ...
        strsql = "select codiceregione,denominazione from enti where idente=" & IdEnteReferenteProgramma
        dataReader = ClsServer.CreaDatareader(strsql, Session("Conn"))
        dataReader.Read()
        If dataReader.HasRows = True Then
            If chkAltroEnte.Checked = True Then
                txtcodNZ.Visible = True
                txtcodNZ.Text = dataReader("codiceregione")
            End If
        End If
        ChiudiDataReader(dataReader)

        strsql = "select codiceregione,denominazione from enti where idente=" & IDEntePresentante
        dataReader = ClsServer.CreaDatareader(strsql, Session("Conn"))
        dataReader.Read()
        If dataReader.HasRows = True Then

            lblcodiceentePropo.Text = dataReader("codiceregione")
    ...
    Sub InVisualizzazione()
        ...
        ddlRequisitiVolontari.Enabled = False
        ...
        txtGiorniPrevistiUE.Enabled = False
        ddlTransfrontaliero.Enabled = False        '*******************************
        ...
        txtGiorniPrevistiTutoraggio.Enabled = False
        ...
        txtNumeroMesiEstero.Enabled = False
        txtDataInizioPrevista.Enabled = False
        ...
        txtcodNZ.Enabled = False
        chkAltroEnte.Enabled = False
        chkCoProgettato.Enabled = False
        ddlPartner.Enabled = False
        txtNumeroGiovaniMinoriOpportunita.Enabled = False
        ddlCategoriaMO.Enabled = False
        If ddlCategoriaMO.SelectedValue <> "" Then
            If ddlCategoriaMO.SelectedValue = 5 Then
                txttipodis.Enabled = False
            End If
        End If

        txtorecollettive.Enabled = False
        txtoreindividuali.Enabled = False
    ...
    Private Sub imgCancella_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles imgCancella.Click
        ...
        mycommand.Connection = Session("conn")
        strLocal = "SELECT isnull(idprogramma,0) as idprogramma from attività where idattività=" & Request.QueryString("IdAttivita")
        ...
        If dtrLocal.HasRows = True Then
            dtrLocal.Read()
            idprogramma = dtrLocal("idprogramma")
            ChiudiDataReader(dtrLocal)
        End If


        'update stato attività
        strLocal = "update attività set IDStatoAttività=(select IdStatoAttività from StatiAttività where Cancellata=1), idprogramma = null where idattività=" & CInt(Request.QueryString("IdAttivita"))
        mycommand.CommandText = strLocal
        ...
        If idprogramma <> 0 Then
            ...
            myCommandSP.CommandText = "SP_PROGRAMMI_AGGIORNA_SETTORI"
            myCommandSP.ExecuteNonQuery()
    ...
    Private Sub imgRipristina_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles imgRipristina.Click
        ...
        txtIdAmbitoAttivita.Value = txtIdAreaPrincipale.Value
        strIdAmbitiModifica.Value = txtIdAree.Value
        'areasecondaria SANDOKAN ADC 12/01/2021
        txtIdAttivitaCaratteristicaOrganizzativa.Value = txtIdAttOrganizzativa.Value
        txtIdAttivitaFormazioneSpecifica.Value = txtIdFormSpecifica.Value
        txtIdAttivitaAltroFormazione.Value = txtIdAltro.Value
        txtCodAttivita.Value = txtCodAtt.Value
    ...
    Private Sub ddlSettore_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlSettore.SelectedIndexChanged
        ...
        If ddlSettore.SelectedValue <> "0" Then
            ...
            If ClsUtility.SETTORI_VERIFICA(Session("conn"), strIdattivita, ddlSettore.SelectedValue) = False Then
                lblerroreSettore.Text = "Il settore selezionato non &#232; congruo con le Sedi associate al progetto."
                'CaricaComboAreaPrimaVolta()
                MaintainScrollPositionOnPostBack = False
                lblerrore.Focus()
                Exit Sub
            ...
            If ClsUtility.SETTORI_VERIFICA_FLAGCVOLP(Session("conn"), strIdattivita, ddlSettore.SelectedValue) = False Then
                lblerroreSettore.Text = "Il settore selezionato non &#232; compatibile con la scelta di non caricare il CV di uno o più OLP."
                'CaricaComboAreaPrimaVolta()
                MaintainScrollPositionOnPostBack = False
                lblerrore.Focus()
                Exit Sub
            ...
            CaricaComboAreaSecondaria(CInt(ddlSettore.SelectedValue))
            ddlAreaSecondaria.SelectedValue = "0"
            ddlAreaSecondaria.Enabled = True
    ...
    Private Sub ddlArea_SelectedIndexChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles ddlArea.SelectedIndexChanged
        ...
        End If
    End Sub
    Private Sub ddlAreaSecondaria_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlAreaSecondaria.SelectedIndexChanged
        lblMessaggioConferma.Text = String.Empty

        Dim strIdattivita As String
        Dim strIdAreaSec As String
        strIdattivita = Request.QueryString("IdAttivita")
        If ddlAreaSecondaria.SelectedValue <> "0" Then
            strIdAreaSec = Mid(ddlAreaSecondaria.SelectedValue, 1, InStr(ddlAreaSecondaria.SelectedValue, "|") - 1)
            If ClsUtility.CAUSALI_ACCOMPAGNA(Session("conn"), strIdattivita, strIdAreaSec) = False Then
                lblerroreSettore.Text = "Impossibile cambiare causale: eliminare prima i/il sogetti/o ad esso legati/o."
                lblerrore.Text = String.Empty
                lblareaerrore.Text = String.Empty
                Exit Sub
    ...
    Private Sub CaricaComboCategorieOpportunità()
        ...
        If ddlCategoriaMO.SelectedValue = 5 Then
            lbltipodisabilità.Visible = False
            txttipodis.Visible = False
        End If
    ...
    Sub CaricaComboAreaPrimaVolta()
        ...
        End If
    End Sub
    Sub CaricaComboAreaSecondariaPrimaVolta()
        'datareader locale per il caricamento della combo dei settori
        Dim dtrAreeSec As SqlClient.SqlDataReader
        'variabile stringa locale per costruire la query per le aree
        Dim strSql As String
        'controllo e chiudo il datareader qualora fosse rimasta appesa la connessione
        If Not dtrAreeSec Is Nothing Then
            dtrAreeSec.Close()
            dtrAreeSec = Nothing
        End If
        'preparo la query per i settori
        strSql = "select '0' as IDCodSec,'Selezionare' as AreeSec order by IDCodSec"
        'eseguo la query e passo il risultato al datareader
        dtrAreeSec = ClsServer.CreaDatareader(strSql, Session("conn"))
        'controllo se ci sono dei record
        If dtrAreeSec.HasRows = True Then

            ' ----------------------area secondaria----------------------------
            ddlAreaSecondaria.DataSource = dtrAreeSec
            ddlAreaSecondaria.DataTextField = "AreeSec"
            ddlAreaSecondaria.DataValueField = "IDCodSec"
            ddlAreaSecondaria.DataBind()
            'ddlAreaSecondaria.SelectedValue = "0"
            'txtIdAreaSecondaria.Value = "0"
            'intIDAmbitoAttivitàSecondario = 0
        End If
    ...
    Sub CaricaComboArea(ByVal idSettoreSelezionato As Integer)
        ...
        ChiudiDataReader(dtrAree)
    End Sub
    Sub CaricaComboAreaSecondaria(ByVal idSettoreSelezionato As Integer)
        Dim dtrAree As SqlClient.SqlDataReader
        'variabile stringa locale per costruire la query per le aree
        Dim strSql As String
        'controllo e chiudo il datareader qualora fosse rimasta appesa la connessione
        ...
        strSql = "select (convert(varchar(10),ambitiattività.IdAmbitoAttività) + '|' + ambitiattività.Codifica + ' - ' + ambitiattività.AmbitoAttività) as IDCodSec, (ambitiattività.Codifica + ' - ' + ambitiattività.AmbitoAttività) as AreeSec "
        strSql = strSql & "from associaambititipiprogetto "
        strSql = strSql & "inner join ambitiattività on associaambititipiprogetto.idambitoattività=ambitiattività.idambitoattività "
        strSql = strSql & "where ambitiattività.IdMacroAmbitoAttività=" & idSettoreSelezionato & " and associaambititipiprogetto.idtipoprogetto=" & Request.QueryString("Nazionale") & " and ambitiattività.attivo=1 "
        strSql = strSql & "union "
        strSql = strSql & "select '0','Selezionare' from ambitiattività order by AreeSec "
        dtrAree = ClsServer.CreaDatareader(strSql, Session("conn"))
        If dtrAree.HasRows = True Then
            ddlAreaSecondaria.DataSource = dtrAree
            'Descrizione dei settori
            ddlAreaSecondaria.DataTextField = "AreeSec"
            'id del settore
            ddlAreaSecondaria.DataValueField = "IDCodSec"
    ...
    Private Function ValidaCampi() As Boolean
        ...
        Dim strSQL As String
        Dim myidente As Integer

        'If ControlloCompetenzaMisureAggiuntive() = False Then
        '    lblareaerrore.Text = String.Empty
        '    errore.AppendLine("Errore Competenza - eliminare sedi di competenza su piu' regioni. <br/>") Ciao
        'End If
        If chkAltroEnte.Checked = True Then
            If (txtcodNZ.Text = String.Empty) Then
                errore.AppendLine("Sezione Progetto - Inserire il codice dell'ente proponente del Programma. <br/>")
            Else
                If ControlloReferenteProgramma(myidente) = False Then
                    errore.AppendLine("Sezione Progetto - Il codice dell'ente proponente del Programma non è valido. <br/>")
                Else
                    If ControlloReferenteProgrammaAssociato(myidente) = False Then
                        errore.AppendLine("Sezione Progetto - Il codice dell'ente proponente del Programma non può essere modificato in quanto il progetto è già associato ad un programma. <br/>")
                    End If
                End If
            End If
        Else
            If ControlloReferenteProgrammaAssociato(Session("IdEnte")) = False Then
                errore.AppendLine("Sezione Progetto - Il codice dell'ente proponente del Programma non può essere modificato in quanto il progetto è già associato ad un programma. <br/>")
            End If
        End If
        ...
        '12/01/2021 verificare che le aree inserite siano diverse Antonello
        If (ddlArea.SelectedIndex.ToString = ddlAreaSecondaria.SelectedIndex.ToString) Then
            ddlAreaSecondaria.SelectedValue = "0"
        End If
        ...
        Else
            If Request.QueryString("IdAttivita") <> "" Then
                If VerificaCongruenzaDurataProgramma(Request.QueryString("IdAttivita"), ddlDurata.SelectedValue) = False Then
                    errore.AppendLine("Sezione Progetto - La durata del progetto non è congruente con gli altri progetti associati al programma. <br/>")
                End If
            End If
        End If
        If ddlRequisitiVolontari.SelectedValue = -1 Then
            lblareaerrore.Text = String.Empty
            errore.AppendLine("Sezione Progetto - Selezionare gli ulteriori requisiti richiesti ai candidati. <br/>")
        End If
        ...
        Select Case Request.QueryString("Nazionale")
            ...
            Case 9, 11, 4 'ZORRO
                ...
                If Not Request.QueryString("IdAttivita") Is Nothing Then
                    ...
                    pfnOpenDataReader(dataReader, strSQL)
                    Select Case optEstero.Checked
                        ...
                        Case True ' non è possibile togliere il transfrontaliero se è presente una sede estera senza vitto e alloggio
                            If ddlTransfrontaliero.SelectedValue = 0 Then ' NO
                                If dataReader.HasRows Then
                                    dataReader.Read()
                                    If dataReader("NumeroPostiVitto") > 0 Or dataReader("NumeroPostiNoVittoNoAlloggio") > 0 Then
                ...
                Else
                    ...
                    Dim intorecollettive As Integer
                    Dim Intoreindividuali As Integer
                    ...
                    If optTutoraggio.Checked Then
                        ...
                        intorecollettive = Val(txtorecollettive.Text)
                        Intoreindividuali = Val(txtoreindividuali.Text)
                        If txtorecollettive.Text = "" And intorecollettive = 0 Then
                            errore.AppendLine("Sezione Progetto - Il valore inserito delle ore collettive previste per il Tutoraggio non è valido. <br/>")
                        End If

                        'If txtoreindividuali.Text = "" And Intoreindividuali = 0 Then
                        '    errore.AppendLine("Sezione Progetto - Il valore inserito delle ore individuali previste per il Tutoraggio non è valido. <br/>")
                        'End If

                        If Val(txtoreindividuali.Text) < 4 Then
                            errore.AppendLine("Sezione Progetto - Il minimo di ore individuali previste per i tutoraggio non deve essere inferiore alle 4 ore. <br/>")
                        End If
                        If Val(txtorecollettive.Text) + Val(txtoreindividuali.Text) < 20 Then
                            errore.AppendLine("Sezione Progetto - Il minimo di ore totali previste per i tutoraggio non deve essere inferiore alle 20 ore. <br/>")
                        End If
                    End If
                End If
        ...
        '    End If
        'End If
        Select Case ddlPartner.SelectedValue
            Case -1
                lblareaerrore.Text = String.Empty
                errore.AppendLine("Sezione Caratteristiche Organizzative - Selezionare Presenza Partners Si/No. <br/>")
        End Select
        ...
        End If
        If (Request.QueryString("Nazionale") = "2") Or (Request.QueryString("Nazionale") = "8") Or (Request.QueryString("Nazionale") = "10") Or (Request.QueryString("Nazionale") = "12") Then
    ...
    Protected Sub CheckMonteOreTipo_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles CheckMonteOreTipo.SelectedIndexChanged
        ...
        If CheckMonteOreTipo.SelectedValue = "0" Or CheckMonteOreTipo.SelectedValue = "selezionare" Then
            ...
            If CheckMonteOreTipo.SelectedValue = "0" Then
                txtOreServizioSettimanali.Text = "25"
            End If
        Else
    ...
    Protected Sub ConfiguraPostBackSezioni()
        ...
        Me.hdnIsPostbackEnte.Value = isPostBack
        ...
        Me.hdnIsPostbackProgetto.Value = isPostBack
    End Sub
    ...
    Function Salva(ByVal ModificaInserimento As Integer) As Integer
        ...
        ChiudiDataReader(dtrLocal)
        Dim IdEnteReferenteProgramma As Integer
        'se si tratta di INSERIMENTO  ADC
        Select Case ModificaInserimento
            Case 0
                ...
                ChiudiDataReader(dtrLocale)
                If chkAltroEnte.Checked = True Then
                    strsql1 = "Select idente from enti where codiceregione='" & txtcodNZ.Text & "'"
                    dtrLocale = ClsServer.CreaDatareader(strsql1, Session("conn"))
                    dtrLocale.Read()
                    If dtrLocale.HasRows = True Then
                        IdEnteReferenteProgramma = dtrLocale("IdEnte")
                    End If
                Else
                    IdEnteReferenteProgramma = CInt(Session("IdEnte"))
                End If
                ChiudiDataReader(dtrLocale)
                ...
                Try
                    ...
                    'If strIdRegioneCompetenza <> "NAZ" And Request.QueryString("Nazionale") <> 11 Then ' BOOO ZORRO
                    '    Select Case Request.QueryString("Nazionale")
                    ...
                    '            intIdRegioneCompetenza = 22
                    '            strIdRegioneCompetenza = "NAZ"
                    '        Case 11 ' Pregetto 2020 Italia
                    '            intIdRegioneCompetenza = 22
                    '            strIdRegioneCompetenza = "NAZ"
                    '        Case 12 'Progetto 2020 Estero
                    '            intIdRegioneCompetenza = 22
                    '            strIdRegioneCompetenza = "NAZ"
                    ...
                    'Dim dtrLocal1 As SqlClient.SqlDataReader
                    'Dim identeriferimentoprogramma As Integer
                    'Dim localcommand As New System.Data.SqlClient.SqlCommand

                    'If chkAltroEnte.Checked = True Then
                    '    localcommand.Connection = Session("conn")
                    '    strSql = "Select idente from enti where codiceregione='" & txtcodNZ.Text & "'"
                    '    localcommand.CommandText = strSql
                    '    dtrLocal1 = localcommand.ExecuteReader


                    '    If dtrLocal1.HasRows = True Then
                    '        dtrLocal1.Read()
                    '        identeriferimentoprogramma = dtrLocal1("IdEnte")
                    '    End If
                    '    ChiudiDataReader(dtrLocal1)
                    'Else
                    '    identeriferimentoprogramma = CInt(Session("IdEnte"))
                    'End If
                    ...
                    strSql = "INSERT INTO attività (Titolo, CodiceEnte, IdEntePresentante, DescrizioneContestoPolitico, DescrizioneContestoTerritoriale, " & _
                             ...
                             "NumeroPostiNoVittoNoAlloggio, NumeroPostiVitto, IDStatoAttività, IDAmbitoAttività,IDAmbitoAttivitàSecondario, OreSettimanali, " & _
                             ...
                             "EsteroUE, NMesiEsteroUE, NGiorniEsteroUE, Transfrontaliero, ModalitàTransfrontaliero, Tutoraggio, NMesiTutoraggio, NGiorniTutoraggio,IdEnteReferenteProgramma,DescrizioneDisabilità,NumeroOreCollettive,NumeroOreIndividuali) "
                    ...
                    If ddlAreaSecondaria.SelectedItem.Value = "0" Then
                        strValues &= "null, " ' 
                    Else
                        strValues &= CInt(Mid(ddlAreaSecondaria.SelectedItem.Value, 1, InStr(ddlAreaSecondaria.SelectedItem.Value, "|") - 1)) & ", "        'IDAmbitoAttivitàSecondario()
                    End If
                    ...
                    Select Case Request.QueryString("Nazionale")
                        ...
                        Case 9, 11, 4
                            ...
                            strValues &= IIf(chkGiovaniMinoriOp.Checked, "1, 0, " & ddlCategoriaMO.SelectedValue & ", ", "0, null, null, ")
                    ...
                    If Request.QueryString("Nazionale") = 11 Or Request.QueryString("Nazionale") = 12 Or Request.QueryString("Nazionale") = 4 Then
                        strValues &= "," & IdEnteReferenteProgramma
                    Else
                        strValues &= ",null"
                    End If
                    'disabilità ADC
                    If ddlCategoriaMO.SelectedValue = 5 Then
                        strValues &= ",'" & Replace(txttipodis.Text, "'", "''") & "'"
                    ...
                    If optTutoraggio.Checked = True Then
                        strValues &= "," & Val(txtorecollettive.Text) & "," & Val(txtoreindividuali.Text) & ""
                    Else
                        strValues &= ",null,null"
                    End If
                    ...
                    strProg = strProg & " RequisitiVolontari, RisorseNecessarie, "

                    'Antonello 25/11/2019
                    'strProg = strProg & "CondizioniRischio, LivelliSicurezza, CondizioniDisagio, "

                    strProg = strProg & "ComunicazioneAutorità, CollegamentoSedeItaliana, ModalitàRientri, AssicurazioneIntegrativa,Partners) "
                    ...
                    Select Case ddlRequisitiVolontari.SelectedValue 'ulteriori requisiti volontari
                        Case 0
                            strProg = strProg & "0, " ' RequisitiVolontari
                        Case 1
                            strProg = strProg & "1, " ' RequisitiVolontari
                        Case Else
                            strProg = strProg & "null, " ' RequisitiVolontari
                    End Select
                    ...
                    Select Case ddlEventualeAssicurazione.SelectedValue
                        Case 0
                            strProg = strProg & "'0', " ' EventualeAssicurazione
                        Case 1
                            strProg = strProg & "'1', " ' EventualeAssicurazione
                        Case Else
                            strProg = strProg & "null, " ' EventualeAssicurazione
                    End Select
                    Select Case ddlPartner.SelectedValue
                        Case 0
                            strProg = strProg & "'0') " ' Partner
                        Case 1
                            strProg = strProg & "'1') " ' Partner
                        Case Else
                            strProg = strProg & "null) " ' Partner
                    End Select
                    ...
                    strProg = "insert into AttivitàCaratteristicheConoscenze (IdAttività) "
                    strProg = strProg & "values "
                    strProg = strProg & "(" & idAttivitaMemorizzata & ")"
                    myCommand.CommandText = strProg
                    myCommand.ExecuteNonQuery()
                    ...
                    'inserimento su AttivitàCaratteristicheConoscenze
                    'strProg = "insert into AttivitàCaratteristicheConoscenze (IdAttività,  "
                    'strProg = strProg & " CompetenzeAcquisibili) "
                    'strProg = strProg & "values "
                    'strProg = strProg & "(" & idAttivitaMemorizzata & ", " ' IdAttività
                    ...
                    strProg = strProg & " SistemaFormazioneAccreditato, DurataFormazioneGenerale,CodiceEnteModalitàFormazioneGenerale,TipoFormazioneGenerale,DurataFormazioneGenerale1,DurataFormazioneGenerale2) "
                    strProg = strProg & "values "
                    strProg = strProg & "(" & idAttivitaMemorizzata & ", " ' IdAttività
                    ...
                    strProg = strProg & " CompetenzeFormatori, Durata,CodiceEnteModalitàFormazioneSpecifica,TipoFormazioneSpecifica,DurataFormazioneSpecifica1,DurataFormazioneSpecifica2) "
                    strProg = strProg & "values "
                    strProg = strProg & "(" & idAttivitaMemorizzata & ", " ' IdAttività
                    strProg = strProg & "null, " ' SedeRealizzazione
            ...
            Case Else 'MODIFICA
                ...
                Else
                    ChiudiDataReader(dtrLocale)
                    strsql1 = "SELECT attività.IdEnteReferenteProgramma, attività.IDEntePresentante FROM attività  where IDAttività=" & CInt(Request.QueryString("IdAttivita"))
                    dtrLocale = ClsServer.CreaDatareader(strsql1, Session("conn"))
                    dtrLocale.Read()
                    If dtrLocale.HasRows = True Then
                        IdEnteReferenteProgramma = dtrLocale("IDEntePresentante")
                    End If
                End If
                ChiudiDataReader(dtrLocale)
                ...
                Try
                    ...
                    strSql &= ", IDAmbitoAttività = " & Val(Mid(ddlArea.SelectedItem.Value, 1, InStr(ddlArea.SelectedItem.Value, "|") - 1))
                    If ddlAreaSecondaria.SelectedItem.Value = "0" Then
                        strSql &= ", IDAmbitoAttivitàSecondario = null"
                    Else
                        ' IDAMBITO ATTIVITA'  ANTONELLO
                        strSql &= ", IDAmbitoAttivitàSecondario = " & Val(Mid(ddlAreaSecondaria.SelectedItem.Value, 1, InStr(ddlAreaSecondaria.SelectedItem.Value, "|") - 1))         ' IDAMBITO ATTIVITA' SECONDARIO ANTONELLO
                    End If
                    ...
                    Select Case Request.QueryString("Nazionale")
                        ...
                        Case 9, 11, 4
                            ...
                            strSql &= IIf(chkGiovaniMinoriOp.Checked, ", GiovaniMinoriOpportunità = 1, IDParticolaritàEntità = " & ddlCategoriaMO.SelectedValue, ",GiovaniMinoriOpportunità = 0, NumeroGiovaniMinoriOpportunità = NULL, IDParticolaritàEntità = NULL")
                    ...
                    End Select
                    If Request.QueryString("Nazionale") = 11 Or Request.QueryString("Nazionale") = 12 Or Request.QueryString("Nazionale") = 4 Then
                        strSql &= ", IdEnteReferenteProgramma = " & IdEnteReferenteProgramma
                    Else
                        strSql &= ", IdEnteReferenteProgramma =null"
                    End If



                    If ddlCategoriaMO.SelectedValue = 5 Then
                        strSql &= ", DescrizioneDisabilità = '" & Replace(txttipodis.Text, "'", "''") & "' "
                    Else
                        strSql &= ", DescrizioneDisabilità =null"
                    End If


                    If optTutoraggio.Checked = True Then
                        strSql &= ", NumeroOreCollettive = " & Val(txtorecollettive.Text) & ", NumeroOreIndividuali = " & Val(txtoreindividuali.Text) & ""
                    Else
                        strSql &= ", NumeroOreCollettive =null, NumeroOreIndividuali=null "
                    End If
                    ...
                    If chkGiovaniMinoriOp.Checked = False Then
                        'ripulisco numeropostigmo su sedi in caso di progetto non GMO
                        strSql = "update attivitàentisediattuazione set NumeroPostiGMO = 0 where IDAttività=" & CInt(Request.QueryString("IdAttivita"))
                        myCommand.CommandText = strSql
                        myCommand.ExecuteNonQuery()
                    End If
                    ...
                    'End If
                    strProg = strProg & "RequisitiVolontari = " & ddlRequisitiVolontari.SelectedValue & ","
                    ...
                    If CInt(Request.QueryString("Nazionale")) = 12 Then   'Or CInt(Request.QueryString("Nazionale")) = 10 Then
                        'Antonello 25/11/2019
                        'Select Case ddlCondizioniRischio.SelectedValue
                        '    Case 0
                    ...
                    Select Case ddlPartner.SelectedValue
                        Case 0
                            strProg = strProg & "Partners=0 " ' Partner
                        Case 1
                            strProg = strProg & "Partners=1 " ' Partner
                    End Select
                    strProg = strProg & " where IDAttività=" & CInt(Request.QueryString("IdAttivita"))
                    myCommand.CommandText = strProg
                    myCommand.ExecuteNonQuery()
    ...
    Private Function pfnCtrlGiovaniMO(ByRef vlErrore As StringBuilder, Optional ByVal vlObbligatorio As Boolean = False)
        ...
        Else
            ...
            'End If
            If ddlCategoriaMO.SelectedValue = 5 And txttipodis.Text = "" Then
                vlErrore.AppendLine("Sezione Progetto - Descrivere il tipo di disabilità . <br/>")
            End If
    ...
    Private Function VerificaCongruenzaDurataProgramma(ByVal idattività As Integer, ByVal durata As Integer) As Boolean
        Dim strsqlLocal As String
        Dim dtrLocal As System.Data.SqlClient.SqlDataReader
        strsqlLocal = "select attività.idattività from attività where IdProgramma = (select isnull(IdProgramma,-1) from attività where IDAttività = " & idattività & ") and IDAttività <> " & idattività & " and NMesi<> " & durata

        'controllo se utente o ente regionale
        'eseguo la query
        dtrLocal = ClsServer.CreaDatareader(strsqlLocal, Session("conn"))
        dtrLocal.Read()
        If dtrLocal.HasRows Then
            VerificaCongruenzaDurataProgramma = False
        Else
            VerificaCongruenzaDurataProgramma = True
        End If
        ChiudiDataReader(dtrLocal)
    ...
    Private Sub pfnCtrlMesiDurata(ByRef vlErrore As StringBuilder)
        ...
        If (txtNumeroMesiEstero.Text = String.Empty) Then
            vlErrore.AppendLine("Sezione Estero - Specificare il numero dei mesi da un minimo di 5 ad un massimo di 12 in base al tipo di progetto scelto. <br/>")
            Exit Sub
        End If
        ...
        End Select
    End Sub
    Private Sub CaricaGriglie()
        Dim sqlDAPstrNomeStoreEnteAccoglienza As New SqlClient.SqlDataAdapter
        Dim dataSetstrNomeStoreEnteAccoglienza As New DataSet
        Dim strNomeStoreEnteAccoglienza As String = "[SP_PROGETTO_EntiAccoglienzaSedi]"

        Try
            sqlDAPstrNomeStoreEnteAccoglienza = New SqlClient.SqlDataAdapter(strNomeStoreEnteAccoglienza, CType(Session("conn"), SqlClient.SqlConnection))
            sqlDAPstrNomeStoreEnteAccoglienza.SelectCommand.CommandType = CommandType.StoredProcedure
            sqlDAPstrNomeStoreEnteAccoglienza.SelectCommand.Parameters.Add("@idattività", SqlDbType.VarChar).Value = CInt(Request.QueryString("IdAttivita"))
            sqlDAPstrNomeStoreEnteAccoglienza.Fill(dataSetstrNomeStoreEnteAccoglienza)
            Session("appDtsRisRicercaEnteAccoglienza") = dataSetstrNomeStoreEnteAccoglienza
            dgRicercaEnteAccoglienza.DataSource = dataSetstrNomeStoreEnteAccoglienza
            dgRicercaEnteAccoglienza.DataBind()
            dgRicercaEnteAccoglienza.Visible = True
        Catch ex As Exception
            Response.Write(ex.Message.ToString())
            Exit Sub
        End Try
        ...
        Dim sqlDAPstrNomeStoreEnteCooprogettante As New SqlClient.SqlDataAdapter
        Dim dataSetstrNomeStoreEnteCooprogettante As New DataSet
        Dim strNomeStoreEnteCooprogettante As String = "[SP_PROGETTO_EntiCoprogettanti]"

        Try
            sqlDAPstrNomeStoreEnteCooprogettante = New SqlClient.SqlDataAdapter(strNomeStoreEnteCooprogettante, CType(Session("conn"), SqlClient.SqlConnection))
            sqlDAPstrNomeStoreEnteCooprogettante.SelectCommand.CommandType = CommandType.StoredProcedure
            sqlDAPstrNomeStoreEnteCooprogettante.SelectCommand.Parameters.Add("@idattività", SqlDbType.VarChar).Value = CInt(Request.QueryString("IdAttivita"))
            sqlDAPstrNomeStoreEnteCooprogettante.Fill(dataSetstrNomeStoreEnteCooprogettante)
            Session("appDtsRisRicercaEnteCooproggettante") = dataSetstrNomeStoreEnteCooprogettante
            dgRicercaEnteCooproggettante.DataSource = dataSetstrNomeStoreEnteCooprogettante
            dgRicercaEnteCooproggettante.DataBind()
            dgRicercaEnteCooproggettante.Visible = True
        Catch ex As Exception
            Response.Write(ex.Message.ToString())
            Exit Sub
        End Try
    ...
    Private Sub dgRicercaEnteAccoglienza_PageIndexChanged(source As Object, e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles dgRicercaEnteAccoglienza.PageIndexChanged
        dgRicercaEnteAccoglienza.SelectedIndex = -1
        dgRicercaEnteAccoglienza.EditItemIndex = -1
        dgRicercaEnteAccoglienza.CurrentPageIndex = e.NewPageIndex
        'CaricaDataGrid(dgRisultatoRicerca)
        dgRicercaEnteAccoglienza.DataSource = Session("appDtsRisRicercaEnteAccoglienza")
        dgRicercaEnteAccoglienza.DataBind()
    End Sub

    Private Sub dgRicercaEnteCooproggettante_PageIndexChanged(source As Object, e As System.Web.UI.WebControls.DataGridPageChangedEventArgs) Handles dgRicercaEnteCooproggettante.PageIndexChanged
        dgRicercaEnteCooproggettante.SelectedIndex = -1
        dgRicercaEnteCooproggettante.EditItemIndex = -1
        dgRicercaEnteCooproggettante.CurrentPageIndex = e.NewPageIndex
        'CaricaDataGrid(dgRisultatoRicerca)
        dgRicercaEnteCooproggettante.DataSource = Session("appDtsRisRicercaEnteCooproggettante")
        dgRicercaEnteCooproggettante.DataBind()
    End Sub
    Private Function ControlloReferenteProgramma(ByRef idente As Integer) As Boolean
        Dim dtrLocale As SqlClient.SqlDataReader
        Dim strsql1 As String
        ChiudiDataReader(dtrLocale)

        If chkAltroEnte.Checked = True Then
            strsql1 = "select idente from enti where albo='SCU' and IDStatoEnte in(3,9) and IDClasseAccreditamento in(8,9) and  codiceregione='" & txtcodNZ.Text.Replace("'", "''") & "'"
            dtrLocale = ClsServer.CreaDatareader(strsql1, Session("conn"))
            dtrLocale.Read()
    ...
    Private Function ControlloReferenteProgrammaAssociato(ByVal idente As Integer) As Boolean
        Dim dtrLocale As SqlClient.SqlDataReader
        Dim strsql1 As String
        If Request.QueryString("IdAttivita") <> "" Then
            ChiudiDataReader(dtrLocale)
            strsql1 = "select identeproponente from programmi a inner join attività b on a.idprogramma = b.idprogramma where b.idattività = " & Request.QueryString("IdAttivita")
            dtrLocale = ClsServer.CreaDatareader(strsql1, Session("conn"))
            dtrLocale.Read()

            If dtrLocale.HasRows = True Then
                If idente = dtrLocale("identeproponente") Then
                    ChiudiDataReader(dtrLocale)
                    Return True
                Else
                    ChiudiDataReader(dtrLocale)
    ...
    End Function
    Private Sub ddlPartner_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlPartner.SelectedIndexChanged

    End Sub
    Private Sub CalcolaPercentualeGMO()
        'Dim tot As Integer = txtNumTotVolontaridaImpiegare.Text
        'Dim Gmo As Integer = txtNumeroGiovaniMinoriOpportunita.Text
        'txtGMOPerc.Text = tot / Gmo
        'txtGMOPerc.Text = txtGMOPerc.Text * 100
        ...
        dividendo = CDbl(Val(txtNumeroGiovaniMinoriOpportunita.Text))
        divisore = CDbl(Val(txtNumTotVolontaridaImpiegare.Text))

        If dividendo <> 0.0 Then

            percentuale = dividendo / divisore * 100
            txtGMOPerc.Text = percentuale
            txtGMOPerc.Text = Val(txtGMOPerc.Text) '& "%"

        End If
    End Sub
   
    Private Sub ddlCategoriaMO_SelectedIndexChanged(sender As Object, e As System.EventArgs) Handles ddlCategoriaMO.SelectedIndexChanged
        If ddlCategoriaMO.SelectedValue = 5 Then
            lbltipodisabilità.Visible = True
            txttipodis.Visible = True
        Else
        ...
        End If
    End Sub
    Private Sub CalcolaTotaleOreTutoraggio()
        
        Dim orecollettive As Integer = Val(txtorecollettive.Text)
        Dim OreIndividuali As Integer = Val(txtoreindividuali.Text)
        Dim risultato As Integer

        risultato = orecollettive + OreIndividuali
       
        txttotaleore.Text = risultato
    End Sub
    
    Protected Sub btnSeleziona_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btnSeleziona.Click
        Response.Redirect("WfrmProgrammi.aspx?idProgramma=" & idprogramma.Value & "&VengoDa=" & Request.QueryString("VengoDa"))
    End Sub
End Class