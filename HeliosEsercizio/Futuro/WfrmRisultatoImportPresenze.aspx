<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmRisultatoImportPresenze.aspx.vb" Inherits="Futuro.WfrmRisultatoImportPresenze" %>
...
<legend >Presenze/Assenze CSV</legend>
   
    <div class="headers">
        <h2>
            <asp:Label ID="Label5" runat="server" Text="Import Presenze/Assenze"></asp:Label>
        </h2>
    </div>
    <br />
    <p>
