...
Public Class wfrmAnagraficaEnteNoAdeguamento
    Inherits SmartPage
    ...
    Private Sub CaricaProvince()
        Dim sel As New clsSelezionaComune
        sel.CaricaProvincie(ddlProvincia, False, Session("Conn"))
    ...
    Private Function ValidazioneServerSalva() As Boolean
        ...
        If Not result Then
            ...
            Log.Warning(Logger.Data.LogEvent.ANAGRAFICAENTE_VALIDAZIONECAMPI, "DATI INSERITI IN MASCHERA NON CORRETTI PER IL SALVATAGGIO")
        End If
    ...
    Private Function SalvaDatiEnteNoAdeguamento() As Boolean
        ...
        Try
            ...
            LogParamentri.Add("@IdEnte", Session("IdEnte"))

            If txtdenominazione.Text.Trim <> String.Empty Then
                SqlCmd.Parameters.Add("@Denominazione", SqlDbType.VarChar).Value = txtdenominazione.Text 'denominazione ente
                LogParamentri.Add("@Denominazione", txtdenominazione.Text.Trim)
            Else
                SqlCmd.Parameters.Add("@Denominazione", SqlDbType.VarChar).Value = DBNull.Value
                LogParamentri.Add("@Denominazione", String.Empty)
            End If
            ...
            If txtprefisso.Text.Trim <> String.Empty Then
                ...
                LogParamentri.Add("@PrefissoTelefonoRichiestaRegistrazione", txtprefisso.Text.Trim)
            Else
                SqlCmd.Parameters.Add("@PrefissoTelefonoRichiestaRegistrazione", SqlDbType.VarChar).Value = DBNull.Value
                LogParamentri.Add("@PrefissoTelefonoRichiestaRegistrazione", String.Empty)
            End If

            If txtTelefono.Text.Trim <> String.Empty Then
                SqlCmd.Parameters.Add("@TelefonoRichiestaRegistrazione", SqlDbType.VarChar).Value = txtTelefono.Text.Trim 'telefono
                LogParamentri.Add("@TelefonoRichiestaRegistrazione", txtTelefono.Text.Trim)
            Else
                SqlCmd.Parameters.Add("@TelefonoRichiestaRegistrazione", SqlDbType.VarChar).Value = DBNull.Value
                LogParamentri.Add("@TelefonoRichiestaRegistrazione", String.Empty)
            End If

            If Trim(txtemail.Text) <> String.Empty Then
                SqlCmd.Parameters.Add("@Email", SqlDbType.VarChar).Value = txtemail.Text
                LogParamentri.Add("@Email", txtemail.Text.Trim)
            Else
            ...
            'SEDE
            If HFIdSede.Value <> String.Empty Then
            ...
            If TxtDettaglioRecapito.Text <> String.Empty Then
            ...
            Else
                SqlCmd.Parameters.Add("@DettaglioRecapito", SqlDbType.VarChar).Value = DBNull.Value
                LogParamentri.Add("@DettaglioRecapito", String.Empty)
            End If
            ...
            If SqlCmd.Parameters("@Esito").Value = 0 Then
                ...
                Log.Warning(Logger.Data.LogEvent.ANAGRAFICAENTENOADEGUAMENTO_MODIFICA_ERRATA, SqlCmd.Parameters("@messaggio").Value, LogParamentri)
                SalvaDatiEnteNoAdeguamento = False
                Exit Function
            Else
                MessaggiConvalida(SqlCmd.Parameters("@messaggio").Value())
                Log.Information(Logger.Data.LogEvent.ANAGRAFICAENTENOADEGUAMENTO_MODIFICA_CORRETTO, SqlCmd.Parameters("@messaggio").Value, LogParamentri)
            End If
        ...
        Catch Sqlex As SqlException
            ...
            SalvaDatiEnteNoAdeguamento = False
            Log.Error(Logger.Data.LogEvent.ANAGRAFICAENTEACCORDO_MODIFICA_ERRATA, Sqlex.Message)
            Exit Function
        Catch ex As Exception
            lblMessaggio.Text = ex.Message
            SalvaDatiEnteNoAdeguamento = False
            Log.Error(Logger.Data.LogEvent.ANAGRAFICAENTEACCORDO_MODIFICA_ERRATA, ex.Message)
            Exit Function
        End Try
