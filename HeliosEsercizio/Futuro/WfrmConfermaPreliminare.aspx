<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmConfermaPreliminare.aspx.vb" Inherits="Futuro.WfrmConfermaPreliminare" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <fieldset class="ContornoPagina">
        <legend>Conferma Preliminare</legend>
        <div class="wrapper" style="width:100%">
            <div class="headers" >
               <h2><asp:Label ID="lblTitolo" runat="server"  Text="Ricerca Volontari Per Conferma Preliminare"></asp:Label></h2>
            </div>
  ...
  <div>
    ...
    <p>&nbsp;</p>
        ...
        <div class="RigaPulsanti" style="float:right">
             <asp:Button ID="CmdConfermaPreliminare" CssClass="Pulsante" Text="Conferma Preliminare" Visible="false" runat="server"/>&nbsp;
       </div>    
    </fieldset>
