...
Public Class wfrmImportRiattivazione
    ...
    Private Sub CreaTabTemp()
        ...
        '--- CREO TAB TEMPORANEA
        strSql = "CREATE TABLE [#TEMP_COVID19] (" & _
    ...
    Private Sub LeggiCSV()
        ...
        While (xLinea <> "")
            ...
            If swErr = False Then
                ...
                ControlliImport(ArrCampi(0), ArrCampi(2), ArrCampi(4), ArrCampi(5), ArrCampi(6), ArrCampi(7), ArrCampi(8), ArrCampi(9), ArrCampi(10), intEsito, strMessaggio)
        ...
        Reader.Close()
        Writer.Close()
        Response.Redirect("WfrmRisultatoImportRiattivazione.aspx?NomeFile=" & NomeUnivoco & "&Tot=" & Tot & "&TotOk=" & TotOk & "&TotKo=" & TotKo)
    ...
    Private Sub ScriviTabTemp(ByVal pArray() As String)
        ...
        Try
            strsql = "INSERT INTO #TEMP_COVID19 " & _
                     "(CodiceProgetto, " & _
                     "Titolo, " & _
    ...
    Public Sub TipoModalitàServizio()
        ...
        strSQL = "Select Descrizione, Codice From TipiModalitàServizio where riattivazione = 1"
    ...
    Private Sub ControlliImport(ByVal strCodiceProgetto As String, ByVal strCodiceSedeProgetto As String, ByVal strStatoRiattivazione As String, ByVal strModalitàServizio As String, ByVal strNumeroVolontariConConsenso As String, ByVal strCodiceNuovaSedeAccreditata As String, ByVal strDescrizioneNuovaSede As String, strCodiceAttivitàRimodulazione As String, strAltro As String, ByRef intEsito As Integer, ByRef strMessaggio As String)
        ...
        Try
            SqlCmd.CommandText = "SP_RIATTIVAZIONE_CONTROLLI_IMPORT"
