...
Imports Logger.Data
Public Class TabProgettiStraordinari2020
    Inherits SmartPage
...
#End Region
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Request.QueryString("IdAttivita") <> "" Then
            ...
            If chkVisualizzazione.Value = VALORE_TRUE Then
                ...
                RadioButtonCiechi.Enabled = False
                RadioButtonInvalidi.Enabled = False
        ...
        If Page.IsPostBack = False Then
            ...
            'tipo progetto 3 = straordinario
            tipoprog2020.Text = "Grandi invalidi e ciechi civili"
    ...
    Private Sub cmdSalva_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles cmdSalva.Click
        ...
        If (ValidaCampi()) Then
            ...
            Else
                ...
                Response.Redirect("TabProgettiStraordinari2020.aspx?CheckMess=True&Nazionale=" & Request.QueryString("Nazionale") & "&Modifica=" & "1" & "&IdAttivita=" & intMaxIdInserimento & "")
            End If
        End If
    ...
    Sub CaricaProgetto(ByVal IdAttivita As Integer, ByVal Visualizzazione As Integer)
        ...
        strsql = "select a.IDAttività, a.Titolo, a.CodiceEnte, a.IDEntePresentante, ISNULL(A.DATAINIZIOATTIVITà,A.DATAINIZIOPREVISTA) AS DataInizioPrevista, a.NumeroPostiNoVittoNoAlloggio, " & _
                 ...
                 "a.EsteroUE, a.NMesiEsteroUE, a.NGiorniEsteroUE, a.Transfrontaliero, a.ModalitàTransfrontaliero, a.Tutoraggio, a.NMesiTutoraggio, a.NGiorniTutoraggio, b.Partners, a.IdEnteReferenteProgramma, isnull(programmi.titolo,'non associato') as TitoloProgramma " & _
        ...
        Try
            ...
            If dtrLocal.HasRows = True Then
                ...
                '09/10/2020
                'If Request.QueryString("Nazionale") = 11 Or Request.QueryString("Nazionale") = 12 Then
                ...
                'Area - Settore
                strCaricaProgetto = "select ambitiattività.idambitoattività,(convert(varchar(10),ambitiattività.IdAmbitoAttività) + '|' + ambitiattività.Codifica + ' - ' + ambitiattività.AmbitoAttività) as IDCod,ambitiattività.IdMacroAmbitoAttività as IdMacroAmbitoAttivita ,ambitiattività.AmbitoAttività as AmbitoAttivita,(ambitiattività.Codifica + ' - ' + ambitiattività.AmbitoAttività) as Aree, ambitiattività.IDAmbitoAttività as IDAmbitoAttivita, "
                ...
                If dtrLocal.HasRows = True Then
                    ...
                    Dim IdAmbitoAttività = dtrLocal("IDAmbitoAttivita")
                    ChiudiDataReader(dtrLocal)
                    'CaricaComboArea(settore)
                    If IdAmbitoAttività = 72 Then
                        RadioButtonCiechi.Checked = True
                        RadioButtonInvalidi.Checked = False
                    Else
                        RadioButtonCiechi.Checked = False
                        RadioButtonInvalidi.Checked = True
                    End If
        ...
        '    If chkAltroEnte.Checked = True Then
        '        txtcodNZ.Visible = True
        '        txtcodNZ.Text = dtrgenerico("codiceregione")
        '    End If
        'End If
        'ChiudiDataReader(dtrgenerico)
    ...
    Private Sub imgSediProgetto_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles imgSediProgetto.Click
        ...
        If Request.QueryString("popup") <> "1" Then
            ...
            If imgVolontari.Visible = False Then
                Response.Redirect("WebGestioneSediProgetto.aspx?EnteCapoFila=" & blnCapoFila.ToString & "&CoProgettato=False&strTitoloProgetto=""&blnVisualizzaVolontari=" & "False" & "&Modifica=" & Request.QueryString("Modifica") & "&Nazionale=" & Request.QueryString("Nazionale") & "&IdAttivita=" & CInt(Request.QueryString("IdAttivita")) & "" & "&VengoDa=" & Request.QueryString("VengoDa"))
            Else
                Response.Redirect("WebGestioneSediProgetto.aspx?EnteCapoFila=" & blnCapoFila.ToString & "&CoProgettato=False&strTitoloProgetto=""&blnVisualizzaVolontari=" & "True" & "&Modifica=" & Request.QueryString("Modifica") & "&Nazionale=" & Request.QueryString("Nazionale") & "&IdAttivita=" & CInt(Request.QueryString("IdAttivita")) & "" & "&VengoDa=" & Request.QueryString("VengoDa"))
            End If
        Else
            If imgVolontari.Visible = False Then
                Response.Redirect("WebGestioneSediProgetto.aspx?EnteCapoFila=" & blnCapoFila.ToString & "&CoProgettato=False&popup=" & Request.QueryString("popup") & "&strTitoloProgetto=""&blnVisualizzaVolontari=" & "False" & "&Modifica=" & Request.QueryString("Modifica") & "&Nazionale=" & Request.QueryString("Nazionale") & "&IdAttivita=" & CInt(Request.QueryString("IdAttivita")) & "&VengoDa=" & Request.QueryString("VengoDa"))
            Else
                Response.Redirect("WebGestioneSediProgetto.aspx?EnteCapoFila=" & blnCapoFila.ToString & "&CoProgettato=False&popup=" & Request.QueryString("popup") & "&strTitoloProgetto=""&blnVisualizzaVolontari=" & "True" & "&Modifica=" & Request.QueryString("Modifica") & "&Nazionale=" & Request.QueryString("Nazionale") & "&IdAttivita=" & CInt(Request.QueryString("IdAttivita")) & "&VengoDa=" & Request.QueryString("VengoDa"))
            End If
    ...
    Private Sub imgRisorse_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles imgRisorse.Click
        ...
        If Not dtrLocal Is Nothing Then
            ...
            dtrLocal = Nothing
        End If
        Response.Redirect("WebGestioneSediProgettoOlp.aspx?EnteCapoFila=" & blnCapoFila.ToString & "&CoProgettato=False&popup=" & Request.QueryString("popup") & "&Modifica=" & Request.QueryString("Modifica") & "&Nazionale=" & Request.QueryString("Nazionale") & "&IdAttivita=" & CInt(Request.QueryString("IdAttivita")) & "&VengoDa=" & Request.QueryString("VengoDa"))
    End Sub
    ...
    Private Function ValidaCampi() As Boolean
        ...
        If RadioButtonCiechi.Checked = False And RadioButtonInvalidi.Checked = False Then
            errore.AppendLine("Sezione Progetto - Selezionare il tipo di progetto (A/B). <br/>")
        End If
        ...
        Select Case ModificaInserimento
            Case 0
                ...
                Try
                    ...
                    strValues &= IIf(RadioButtonCiechi.Checked, "72", "73") & " , " '     IDAMBITO ATTIVITA'   ANTONELLO
            ...
            Case Else 'MODIFICA
                ...
                Try
                    ...
                    strSql &= ", IDAmbitoAttività = " & IIf(RadioButtonCiechi.Checked, "72", "73")                              ' IDAMBITO ATTIVITA'  ANTONELLO
    ...
    'Protected Sub RadioButtonCiechi_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButtonCiechi.CheckedChanged
    '    RadioButtonInvalidi.Checked = False
    'End Sub

    'Protected Sub RadioButtonInvalidi_CheckedChanged(sender As Object, e As EventArgs) Handles RadioButtonInvalidi.CheckedChanged
    '    RadioButtonCiechi.Checked = False
    'End Sub
End Class