<%@ Page Title="Gestione Vincoli Classe Ente" Language="vb" AutoEventWireup="false" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Site.Master" CodeBehind="WfrmAdeguamento.aspx.vb" Inherits="Futuro.WfrmAdeguamento" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <fieldset class="ContornoPagina" id="FidsetPagina" runat="server">
        <legend>Presentazione domanda di Adeguamento</legend>
			...
			<strong>Chiede di adeguare i dati di iscrizione all'Albo del Servizio Civile Universale<br />
                <br />
                </strong>
...
<%--			<hr />
			...
			<h4>Domanda di Adeguamento</h4>
                        <div class="row">
                <div class="collable" style="width: 10%">
                    <asp:Label ID="lblNoteEsplicative" CssClass="label" runat="server" AssociatedControlID="txtNoteEsplicative"
                        Text="Eventuali note esplicative"></asp:Label>
                </div>
                <div class="colOggetti" style="width: 60%">
                    <asp:TextBox ID="txtNoteEsplicative" TextMode="MultiLine" runat="server" CssClass="textbox"
                        Columns="80" Rows="3" MaxLength="1000" ></asp:TextBox>
                </div>
            </div>
			<p>È necessario scaricare la domanda di adeguamento, apporre la firma digitale e ricaricare il documento firmato</p>
			<br />
			...
			<br />
			<br />
            <asp:Button runat="server" Text="Scarica domanda di adeguamento" Id="Riepilogo" CssClass="Pulsante"/>
			<br /><br />
			<div class="row" runat="server" id="NorowRiepilogo">
				<div class="collable" style="width: 25%">
					<asp:Label ID="lblRiepilogo" CssClass="label" AssociatedControlID="cmdCaricaFileRiepilogo" runat="server" Text="Domanda di adeguamento Firmata"></asp:Label>
				</div>
                <div class="colOggetti" style="width: 35%">
	...
	<asp:Panel ID="pnlUploadRiepilogo" runat="server" Style="background-color: White; padding: 20px; width: 100%; overflow-y: auto; max-height: 90vh">
        ...
        <p class="msgInfo">Caricamento Domanda di Adeguamento</p>
        <fieldset>
