<%@ Page Title="Controllo Risorse" Language="vb" AutoEventWireup="false" CodeBehind="dettRisorseIncompatibili.aspx.vb" Inherits="Futuro.dettRisorseIncompatibili" %>
...
<body>
    ...
    <div class="wrapper" style="width:100%">
      <div class="headers" >
               <h2><asp:Label ID="lblTitolo" runat="server"  Text="Dettaglio Risorsa Incompatibile"></asp:Label></h2>
            </div>
       ...
       <div class="RigaPulsanti">
            <asp:Button ID="imgchiudi" runat="server" CssClass="Pulsante" OnClientClick="javascript:window.close();" Text="Chiudi" />
