<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="WfrmNavigaInfoEnte.aspx.vb" Inherits="Futuro.WfrmNavigaInfoEnte" %>
...
<body>
    ...
    <div class="wrapper"  style="width:100%;border-width:0px">
          <div class="row" style="text-align:right">
                ...
                <asp:Button ID="cmdChiudiPagina" OnClientClick="javascript: window.close();" CssClass="Pulsante" runat="server"  
                  Text="Chiudi" />
