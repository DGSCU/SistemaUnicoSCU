...
Imports System.IO
Public Class WfrmRisultatoImportRimodulazioneProgettiUcraina
    ...
    Private Sub CaricaGriglia()
        ...
        clCSV = New DataColumn
        clCSV.DataType = System.Type.GetType("System.String")
        clCSV.ColumnName = "Numero Volontari Coinvolti"
        clCSV.Caption = "NumeroVolontariCoinvolti"
        clCSV.ReadOnly = False
        clCSV.Unique = False
        dtCSV.Columns.Add(clCSV)
    ...
    Private Sub ScriviUcraina()
        ...
        strsql = "INSERT INTO attivitàentisediattuazione_riattivazione " & _
                 ...
                 "'" & Session("Utente") & "', " & _
                 "getdate(), " & _
                 "CAST(a.NumeroVolontariCoinvolti AS SMALLINT), " & _
                 "case a.DataValidità when '' then null else a.DataValidità end " & _
                 "FROM #TEMP_RimodulazioneUcraina a " & _
                 ...
                 "LEFT JOIN tipiModalitàServizio e on a.ModalitàServizio = e.codice and e.IdTipoEmergenza=2 " & _
                 "LEFT JOIN tipiattivitàrimodulazione f on a.CodiceAttivitàRimodulazione = f.codice and f.rimodulazione = 1 and f.IdTipoEmergenza=2 " & _
        ...
        strsql = "UPDATE attivitàentisediattuazione SET " & _
         ...
         "NumeroVolontariConsenso = CAST(a.NumeroVolontariCoinvolti AS SMALLINT) " & _
         "FROM #TEMP_RimodulazioneUcraina a " & _
         "INNER JOIN attivitàentisediattuazione b ON a.codicesedeprogetto = b.identesedeattuazione " & _
         "INNER JOIN attività c on b.idattività = c.idattività and a.codiceprogetto = c.codiceente " & _
         "INNER JOIN statiriattivazione d on a.StatoRiattivazione = d.codice " & _
    ...
    Protected Sub CmdChiudi_Click(sender As Object, e As EventArgs) Handles CmdChiudi.Click
        CancellaTabellaTemp()
        Response.Redirect("wfrmImportRimodulazioneProgettiUcraina.aspx")
    End Sub
End Class