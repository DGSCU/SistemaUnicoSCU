<%@ Page Title="Anagrafica Sedi Enti" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmAnagraficaSedi.aspx.vb" Inherits="Futuro.WfrmAnagraficaSedi" %>
...
<fieldset class="ContornoPagina">
        ...
        <div class="wrapper" style="width:100%">
           ...
           <br />
           <div id="divFuoriAdeguamento" runat="server" visible="false">
             <fieldset class="ContornoPagina">

                <legend>Modifica sede fuori adeguamento</legend>
               <h3><asp:Label runat="server" ID="Label4" CssClass="labelDati"></asp:Label></h3>
                <div  style="text-align:right">
                 
                  <asp:Button ID="cmdFuoriAdeguamento" CssClass="Pulsante" runat="server" ToolTip="“modifica dei dati che non richiedono adeguamento" Text="modifica dei dati che non richiedono adeguamento" Visible="true" />
                  </div>
            ...
            <div id="divChiusuraSede" class="rowGroup" style="height:auto" runat="server" visible="false">
                ...
                <legend>Chiudi Sede</legend>
                    <div class="wrapper" style="width:100%;border:0px">
                        <div class="row" style="height:auto">
                            <h3><asp:Label runat="server" ID="lblChiudiSede" CssClass="labelDati"></asp:Label></h3>
                        </div>
                        <br />
       ...
       <div class="row">
        ...
        <div class="row">
           ...
           <div class="collable" style="width:8%">          
            ...
            <div class="colOggetti" style="width:15%">
                <asp:TextBox ID="txtTelefono" CssClass="textbox" MaxLength="11" runat="server" Width="100px" ></asp:TextBox>
           </div>
                <div class="collable" style="width:8%">          
        ...
        <div class="row">
            ...
            <div class="colOggetti" style="width:40%">
                ...
                runat="server" CssClass="ddlClass"  Enabled="false"></asp:dropdownlist>
            </div>
        </div>
        <div class="row">
            <div class="collable" style="width:15%">          
   ...
   <!--Inserire qui sopra il fine wrapper-->
    ...
    <br />
      ...
      <asp:Button ID="cmdAccredita" CssClass="Pulsante" runat="server" Text="Iscrivi"  ToolTip="Iscrivi Sede" Visible="False" />
      ...
      <asp:Button ID="cmdVisualizzaDatiAccreditati" CssClass="Pulsante" runat="server"  ToolTip="Visualizza Dati Iscritti"  Text="Visualizza Dati Iscritti"  />
      <asp:Button ID="cmdAnnullaAccred" CssClass="Pulsante" runat="server" ToolTip="Annulla Iscrizione Sede" Text="Annulla Iscrizione" Visible="false" />
