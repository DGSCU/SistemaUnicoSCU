<%@ Page  Title="Gestione Progetti Servizio Civile Universale"  Language="vb" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TabProgettiSCU_DEF.aspx.vb" Inherits="Futuro.TabProgettiSCU_DEF" %>
    ...
    <script  type="text/javascript">
       /* <![CDATA[ */
        ...
        function ControllaTipologiaProgetto() {
            ...
            if ('<%=request.querystring("Nazionale")%>' != '10') {
    ...
    <script type="text/javascript">
     ...
     <script  type="text/javascript">
         ...
         function Salva() {
            ...
            <% If Request.QueryString("Nazionale") = 9  Then %>
...
//             }
             ...
             //SEZIONE ESTERO
             if ('<%=request.querystring("Nazionale")%>' == '8' || '<%=request.querystring("Nazionale")%>' == '10') { //Estero
...
<legend >Progetto di Servizio Civile Universale</legend>
...
<% End If %>
   ...
   <div id="DivMisureAggiuntive" runat="server" visible="true">
       <fieldset>
           <legend>Misure Aggiuntive</legend>
           <div class="wrapper" style="width:100%;border:0px">
            <div class="row">
...
<div class="rowGroup" id="DivSezioneEstero" runat="server">
 ...
 <div class="rowGroup" id="divCoProgettazione" runat="server" visible="false">
   <div class="row">
