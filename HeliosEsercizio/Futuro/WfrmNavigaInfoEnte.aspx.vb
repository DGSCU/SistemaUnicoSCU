Public Class WfrmNavigaInfoEnte
    ...
    Private Sub PopolaMaschera()
        ...
        " where enti.idente=" & Request.QueryString("IdEnte") & ""
        ...
        " WHERE entisedi.IDEnte = " & Request.QueryString("IdEnte") & " And entiseditipi.idtiposede = 1 and (statientisedi.attiva=1 or statientisedi.DefaultStato=1)"
        If Not dtrGenerico Is Nothing Then
            dtrGenerico.Close()
            dtrGenerico = Nothing
        End If
    ...
    Sub CaricaEntiSettori()
        ...
        strSql = "SELECT macroambitiattività.IDMacroAmbitoAttività, macroambitiattività.MacroAmbitoAttività FROM macroambitiattività INNER JOIN EntiSettori ON macroambitiattività.IDMacroAmbitoAttività = EntiSettori.IdMacroAmbitoAttività WHERE EntiSettori.IdEnte = " & Request.QueryString("IdEnte")
    ...
    Protected Sub cmdChiudi_Click(sender As Object, e As EventArgs) Handles cmdChiudi.Click
        ...
        If Request.QueryString("VengoDa") = 1 Then
            Response.Redirect("~/WfrmNavigaEnte.aspx?IdEnte=" & Request.QueryString("IdEnte") & "&VengoDa=" & 4 & "&CodiceFiscale=" & Request.QueryString("CodiceFiscale"))
        End If

        If Request.QueryString("VengoDa") = 3 Then
            Response.Redirect("~/WfrmNavigaEntiAccoglienza.aspx?IdEnte=" & Request.QueryString("identepadre") & "&VengoDa=" & 4 & "&CodiceFiscale=" & Request.QueryString("CodiceFiscale") & "&Denominazione=" & Request.QueryString("Denominazione") & "&CodiceRegione=" & Request.QueryString("CodiceRegione") & "&CF=" & Request.QueryString("CF") & "&Tipologia=" & Request.QueryString("Tipologia") & "&ClasseAccreditamento=" & Request.QueryString("ClasseAccreditamento") & "&Stato=" & Request.QueryString("Stato") & "&Pagina=" & Request.QueryString("Pagina") & "&StatoEnte=" & Request.QueryString("StatoEnte"))
        End If
