<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmRicAccettazioneIstanzaUNSCProgrammi.aspx.vb" Inherits="Futuro.WfrmRicAccettazioneIstanzaUNSCProgrammi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
  <fieldset class="ContornoPagina">
<legend >Ricerca Istanze Programmi</legend>
                                ...
                                <asp:datagrid id="dgRisultatoRicerca" Width="100%" runat="server" 
                                   ...
                                   AutoGenerateColumns="False" UseAccessibleHeader="True">
											...
											<Columns>
												...
												<asp:ButtonColumn Text="..." HeaderText="Dettaglio Istanza" 
                                                    CommandName="Dettagli" Visible="False">
													<HeaderStyle HorizontalAlign="Center" Width="30px"></HeaderStyle>
													<ItemStyle HorizontalAlign="Center"></ItemStyle>
												</asp:ButtonColumn>
												<asp:BoundColumn Visible="False" DataField="idbandoprogramma" 
                                                    HeaderText="idbandoprogramma"></asp:BoundColumn>
												<asp:BoundColumn DataField="programmi" HeaderText="N. Programmi">
													<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
													<ItemStyle HorizontalAlign="Center"></ItemStyle>
                                                </asp:BoundColumn>
