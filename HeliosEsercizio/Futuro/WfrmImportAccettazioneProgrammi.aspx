<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmImportAccettazioneProgrammi.aspx.vb" Inherits="Futuro.WfrmImportAccettazioneProgrammi" %>
...
<fieldset class="ContornoPagina">
        <legend>Importazione File Accettazione Programmi</legend>
        <div id="TabellaImportAssenzeVolontari" class="wrapper" style="width: 100%">
            <div class="headers">
                <h2>
                    <asp:Label ID="Label5" runat="server" Text="Import File Accettazione Programmi"></asp:Label>
                </h2>
            </div>
            <div class="RigaVuota">
                &nbsp;</div>
