<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="TabProgettiStraordinari2020.aspx.vb" MaintainScrollPositionOnPostBack="true"  Inherits="Futuro.TabProgettiStraordinari2020" %>
  ...
  <div id="IdDivRigaFascicolo" class="rowGroup"  runat="server" visible="false" style="height:auto">
   ...
   <div class="row">
      <div class="collable" style="width:33%">
        <asp:Label ID="lblddlSettore" AssociatedControlID="RadioButtonCiechi" Text="A - progetti di accompagnamento dei ciechi civili art.40 legge n.289/2002" runat="server" CssClass="label" />
   </div>
   <div class="colOggetti" style="width:15%">
        <asp:RadioButton ID="RadioButtonCiechi" GroupName="OptCiechiInvalidi" runat="server" />
    </div>
        <div class="collable" style="width:33%">
        <asp:Label ID="lblArea" AssociatedControlID="RadioButtonInvalidi" Text="B - progetti di accompagnamento dei grandi invalidi art.1 legge n.288/2002" runat="server"  CssClass="label"/>
            
   </div>
    <div class="colOggetti" style="width:15%">
       <asp:RadioButton ID="RadioButtonInvalidi" GroupName="OptCiechiInvalidi" runat="server" />
    </div>
       ...
       <fieldset>
           ...
           <div class="wrapper" style="width:100%;border:0px">
            ...
            <div class="row" id="divEsteroTutoraggio" visible = "false" runat="server">
                <div class="collable" style="width:15%">
                    <asp:RadioButton id="optEstero" runat="server" AutoPostBack="true" Enabled="false" 	GroupName="OptEsteroTutoraggio" Checked="False" Text="Estero (UE)" />
                </div>
                <div class="collable" style="width:15%">
