...
Public Class WfrmImportAccettazioneProgrammi
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        hplFile.NavigateUrl = "~/download/Master/AccettazioneProgrammi.csv"
        hplFile.Text = "File AccettazioneProgrammi.csv"
    End Sub
    Private Sub CmdElabora_Click(ByVal sender As Object, ByVal e As EventArgs) Handles CmdElabora.Click
        ...
        If txtSelFile.PostedFile.FileName.ToString <> "" Then
            Try
                NomeUnivoco = "AccettazioneProgrammi" & Session("IdEnte") & "_" & Session("Utente") & "_" & Year(Now) & Month(Now) & Day(Now) & Hour(Now) & Minute(Now) & Second(Now)
                Dim file As String
    ...
    Private Sub CreaTabTemp()
        ...
        '--- CREO TAB TEMPORANEA
        strSql = "CREATE TABLE [#TEMP_ACCETTAZIONE_PROGRAMMI] (" & _
    ...
    Private Sub LeggiCSV()
        ...
        Reader.Close()
        Writer.Close()
        Response.Redirect("WfrmRisultatoImportAccettazioneProgrammi.aspx?NomeFile=" & NomeUnivoco & "&Tot=" & Tot & "&TotOk=" & TotOk & "&TotKo=" & TotKo)
    ...
    Private Sub ScriviTabTemp(ByVal pArray() As String)
        ...
        Try
            strsql = "INSERT INTO #TEMP_ACCETTAZIONE_PROGRAMMI " & _
                     "(CodiceProgramma, " & _
                     "TipoEsitoPositivo " & _
                     ") " & _
                     "values " & _
    ...
    Private Sub ControlliImport(ByVal strCodiceProgetto As String, ByVal strTipoEsitoPositivo As String, ByRef intEsito As Integer, ByRef strMessaggio As String)
        ...
        Try
            SqlCmd.CommandText = "SP_PROGRAMMI_CONTROLLI_IMPORT_ACCETTAZIONE"
            SqlCmd.CommandType = CommandType.StoredProcedure
            SqlCmd.Connection = Session("Conn")

            SqlCmd.Parameters.Add("@Utente", SqlDbType.VarChar, 100).Value = strUtente
            SqlCmd.Parameters.Add("@CodiceProgramma", SqlDbType.VarChar, 1000).Value = strCodiceProgetto
