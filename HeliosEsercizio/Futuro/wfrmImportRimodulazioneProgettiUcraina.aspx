<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="wfrmImportRimodulazioneProgettiUcraina.aspx.vb" Inherits="Futuro.wfrmImportRimodulazioneProgettiUcraina" %>
...
<fieldset class="ContornoPagina">
        <legend>Importazione File Rimodulazione Progetti UCRAINA</legend>
        <div id="TabellaImportAssenzeVolontari" class="wrapper" style="width: 100%">
            <div class="headers">
                <h2>
                    <asp:Label ID="Label5" runat="server" Text="Import File Rimodulazione Progetti UCRAINA"></asp:Label>
                </h2>
            </div>
            <div class="RigaVuota">
                &nbsp;</div>
