...
Public Class WfrmAssicurazioneVolontarioCrono
    ...
    Public Property ServerPath() As String
        Get
            ...
            Return ConfigurationManager.AppSettings("PercorsoFileAssicurazioni")
        End Get
    ...
    End Sub
    Private Sub Ordina(ByRef Lista() As CronoAss)
    ...
    Protected Sub cmdChiudi_Click(sender As Object, e As EventArgs) Handles cmdChiudi.Click
        Response.Redirect("WfrmAssicurazioneVolontari.aspx")
    End Sub
End Class

Public Class CronoAss
