<%@ Page Title="Risultato Importazione File di Graduatorie Volontari" Language="vb"
    AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="wfrmRisultatoImportAssenze.aspx.vb"
    Inherits="Futuro.wfrmRisultatoImportAssenze" %>
...
<legend >Assenze CSV</legend>
   
    <div class="headers">
        <h2>
            <asp:Label ID="Label5" runat="server" Text="Import Assenze"></asp:Label>
        </h2>
    </div>
    <p>
