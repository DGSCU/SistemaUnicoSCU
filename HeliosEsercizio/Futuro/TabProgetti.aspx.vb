...
Imports Logger.Data
Public Class TabProgetti
    Inherits SmartPage
    Dim bnlVisibilitaFAMI As Boolean
...
#End Region
    ...
    Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Page.IsPostBack = False Then
            ...
            '****** RICHIAMO LA STORE CHE GESTISCIONE LA VISIBILITA' DEL FAMI *****
            'AGGIUNTA DA SIMONA CORDELLA IL 09/10/2017

            bnlVisibilitaFAMI = GestioneVisibilitaFAMI(Session("conn"), IIf(Request.QueryString("IdAttivita") = "", 0, Request.QueryString("IdAttivita")), Request.QueryString("Nazionale"))

            If bnlVisibilitaFAMI = True Then
                divFAMI.Visible = True
                divFAMIRic.Visible = True
            Else
                divFAMI.Visible = False
                divFAMIRic.Visible = False
            End If
            '****************************************
    ...
    Private Sub cmdSalva_Click(ByVal sender As System.Object, ByVal e As EventArgs) Handles cmdSalva.Click
        ...
        If (ValidaCampi()) Then
            ...
            Else
                ...
                Response.Redirect("TabProgetti.aspx?CheckMess=True&Nazionale=" & Request.QueryString("Nazionale") & "&Modifica=" & "1" & "&IdAttivita=" & intMaxIdInserimento & "")
            End If
    ...
    Sub CaricaProgetto(ByVal IdAttivita As Integer, ByVal Visualizzazione As Integer)
        ...
        strCaricaProgetto = strCaricaProgetto & "a.Fami, isnull(a.NumeroPostiFamiRichiesti,0) as NumeroPostiFamiRichiesti, isnull(a.NumeroPostiFami,0) as NumeroPostiFami  "
        ...
        If dtrLocal.HasRows = True Then
            ...
            chkFami.Checked = dtrLocal("Fami")
            txtNumeroVolontariFami.Text = dtrLocal("NumeroPostiFami")
            txtNumeroVolontariFamiRic.Text = dtrLocal("NumeroPostiFamiRichiesti")
            'LblInfoFami.Visible = chkFami.Checked
            AbilitaFami(chkFami.Checked)
    ...
    Function Salva(ByVal ModificaInserimento As Integer) As Integer
        ...
        If ModificaInserimento = 0 Then
            ...
            Try
                ...
                Else
                    strProg = strProg & "2"
                End If
                'aggiunto il 03/10/2017 ad simona cordella gestione dei FAMI
                If chkFami.Checked = True Then
                    strProg = strProg & " , 1"
                Else
                    strProg = strProg & " , 0"
                End If
                ...
                ''**** aggiunto da simona cordella il 04/10/2017
                ''azzero i posti fami 
                'If chkFami.Checked = False Then
                '    'AzzeramentoPostiFami(idAttivitaMemorizzata)
                '    strProg = " UPDATE attivitàentisediattuazione SET NumeroPostiFami=0 "
                '    strProg &= " WHERE IDAttività=" & CInt(idAttivitaMemorizzata)
                ...
                '    strProg &= " NumeroPostiFami=0 ,NumeroPostiFamiRichiesti=0  "
                '    strProg &= " WHERE IDAttività=" & CInt(idAttivitaMemorizzata)
        ...
        Else 'MODIFICA
            ...
            Try
                ...
                If chkFami.Checked = True Then
                    strProg = strProg & ", Fami = 1"
                Else
                    strProg = strProg & ", Fami = 0"
                End If

                If (Session("TipoUtente") = "U" Or Session("TipoUtente") = "R") Then
                    'Modifica dei Campi Volontari Richiesti
                    strProg = strProg & ", NumeroPostiFamiRichiesti = " & txtNumeroVolontariFamiRic.Text & ""
                End If
                ...
                If chkFami.Checked = False Then
                    strProg = " UPDATE attivitàentisediattuazione SET NumeroPostiFami=0 "
                    strProg &= " WHERE IDAttività=" & CInt(Request.QueryString("IdAttivita"))
    ...
    Sub InVisualizzazione()
        ...
        '****************************
        '****************************
        'agg. da s.c il 23/10/2017
        chkFami.Enabled = False
        '****************************
        ...
        If (txtOreServizioSettimanali.Text <> String.Empty) Then
            ...
            Else
                If (chkOreSett.Selected = True) Then
                    If (ore < 30) Then
                        errore.AppendLine("Sezione Progetto - Inserire almeno 30 ore di Servizio Settimanale. <br/>")
                    ElseIf (ore > 255) Then
                        errore.AppendLine("Sezione Progetto - Il valore inserito %E8 superiore al numero massimo consentito. <br/>")
                    End If
            ...
            Else
                ...
                Else
                    If (oreAnnue > 32767) Then
                        errore.AppendLine("Sezione Progetto - Il valore inserito del monte ore annuo %E8 superiore al numero massimo consentito. <br/>")
    ...
    Private Sub AzzeramentoPostiFami(ByVal IdAttivita As Integer)
        'creata da simona cordella il 04/10/2017
        Dim myCommand As SqlClient.SqlCommand
        '  Dim MyTransaction As System.Data.SqlClient.SqlTransaction
        Dim strSql As String


        strSql = " UPDATE attivitàentisediattuazione SET NumeroPostiFami=0 "
        strSql &= " WHERE IDAttività=" & IdAttivita

        myCommand = ClsServer.EseguiSqlClient(strSql, Session("conn"))


        strSql = " UPDATE Attività SET "
        strSql &= " NumeroPostiFami=0 ,NumeroPostiFamiRichiesti=0  "
        strSql &= " WHERE IDAttività=" & IdAttivita
    ...
    Private Function GestioneVisibilitaFAMI(ByVal cnLocal As SqlClient.SqlConnection, ByVal IdAttività As Integer, ByVal IdTipoProgetto As Integer) As Integer
        ...
        Dim strNomeStore As String = "[SP_PROGETTO_GestioneVisibilitàFAMI]"
        ...
        Try
            ...
            sqlCMD.Parameters.Add("@IDTIPOPROGETTO", SqlDbType.Int).Value = IdTipoProgetto
            ...
            intValore = sqlCMD.Parameters("@Valore").Value
    ...
    Private Sub chkFami_CheckedChanged(sender As Object, e As System.EventArgs) Handles chkFami.CheckedChanged
        AbilitaFami(chkFami.Checked)
    End Sub

    Private Function AbilitaFami(ByVal Valore As Boolean) As Boolean
        lblNumeroVolontariFami.Visible = Valore
        txtNumeroVolontariFami.Visible = Valore
        LblInfoFami.Visible = Valore
    End Function
End Class