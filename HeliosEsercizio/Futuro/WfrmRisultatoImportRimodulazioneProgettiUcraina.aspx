<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmRisultatoImportRimodulazioneProgettiUcraina.aspx.vb" Inherits="Futuro.WfrmRisultatoImportRimodulazioneProgettiUcraina" %>
...
<legend >Rimodulazione Progetti CSV</legend>
    <div class="headers">
        <h2>
            <asp:Label ID="Label5" runat="server" Text="Rimodulazione Progetti UCRAINA"></asp:Label>
        </h2>
    </div>
    <p>
