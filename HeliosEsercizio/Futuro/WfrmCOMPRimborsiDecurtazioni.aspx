<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmCOMPRimborsiDecurtazioni.aspx.vb" Inherits="Futuro.WfrmCOMPRimborsiDecurtazioni" %>
...
<fieldset class="ContornoPagina">
        <legend>Rimborsi / Decurtazioni</legend>
        <asp:label id="lblmess"  runat="server" CssClass="msgErrore" Visible="False"></asp:label>
        <br />
        <br />
        <div class="wrapper" style="width:100%">
            <div class="headers" >
               <h2><asp:Label ID="lblTitolo" runat="server"  Text="GESTIONE RIMBORSI/DECURTAZIONI"></asp:Label></h2>
            </div>
          </div>
        <div class="wrapper" style="width:100%">
    ...
    <p style="text-align:center">
        <asp:label id="lblTitotloElencoRimborsiDecurtazioni" runat="server" CssClass="bold" Text="Elenco Rimborsi/Decurtazioni"></asp:label>
    </p>
     <asp:datagrid id="dgRisultatoRicercaRimborsiDecurtazioni" runat="server" 
            CssClass="table"  Width="100%" ToolTip="Elenco Rimborsi/Decurtazioni"  
            CellPadding="2"  AllowSorting="True" AutoGenerateColumns="False" 
            AllowPaging="True" PageSize="5" UseAccessibleHeader="True">
		...
		<Columns>
            <asp:TemplateColumn> 
                <ItemTemplate>
					<asp:ImageButton ID="CmdModifica" CommandName="Modifica" ToolTip="Seleziona Rimborsi/Decurtazioni" AlternateText="Seleziona Rimborsi/Decurtazioni" runat="server" ImageURL="images/valida_small.png" CausesValidation="false"></asp:ImageButton>                         
                </ItemTemplate>
            </asp:TemplateColumn>
			<asp:BoundColumn Visible="False" DataField="idElementoRetributivo" HeaderText="idElementoRetributivo"
    ...
    <div class="wrapper" style="width:100%">
        <div class="RigaVuota" style="text-align:center">
            <asp:label id="lblInserimentoRestituzione" runat="server" CssClass="bold" Text="Dettaglio Rimborso/Decurtazione"></asp:label>
        </div>
        <div class="RigaVuota" >&nbsp;</div>
        <div class="row" >
            <div class="collable" style="width:15%">      
         ...
         <div class="row" >
            <div class="collable" style="width:15%">      
                <asp:Label ID="lblTipo" CssClass="label" AssociatedControlID="CboTipo" 
                    runat="server" Text="(*)Tipo"></asp:Label>
            </div>
            <div class="colOggetti" style="width:35%">       
