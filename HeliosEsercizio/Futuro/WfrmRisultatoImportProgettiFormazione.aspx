<%@ Page Title="Importazione Progetti Formazione Generale" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="WfrmRisultatoImportProgettiFormazione.aspx.vb" Inherits="Futuro.WfrmRisultatoImportProgettiFormazione" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
<div class="firefox" >
    <fieldset class="ContornoPaginaScroll" >
        <legend>Importazione Progetti Formazione Generale</legend>
        <div class="headers">
            <h2><asp:Label ID="lblTitolo" runat="server"  Text="Importazione Progetti Formazione"></asp:Label></h2>
        </div>
        <br />
